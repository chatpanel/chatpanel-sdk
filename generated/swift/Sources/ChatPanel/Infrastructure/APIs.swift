...
open class ChatPanelAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "http://127.0.0.1:4320",
    ...
    public static let shared = ChatPanelAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: ChatPanelAPIConfiguration
    ...
    required public init(
        ...
        apiConfiguration: ChatPanelAPIConfiguration = ChatPanelAPIConfiguration.shared
    ) {
        self.method = method
