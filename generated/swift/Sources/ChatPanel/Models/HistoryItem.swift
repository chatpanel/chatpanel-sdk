...
public struct HistoryItem: Sendable, Codable, Hashable {
    ...
    public init(id: String, title: String? = nil, type: RecordType? = nil, date: Int64? = nil, chars: Int? = nil) {
        self.id = id
        self.title = title
        self.type = type
        self.date = date
    ...
    public init(from decoder: Decoder) throws {
        ...
        nonAdditionalPropertyKeys.insert("chars")
