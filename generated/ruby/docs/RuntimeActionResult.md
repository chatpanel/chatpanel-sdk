...
| **install** | **Hash&lt;String, Object&gt;** | A domain object whose shape is owned by &#x60;@chatpanel/events&#x60;; the SDK carries it as-is. | [optional] |
| **provides** | **Array&lt;String&gt;** | The capabilities the service now stands behind (gateway 0.20+). | [optional] |
...
instance = ChatPanel::RuntimeActionResult.new(
  ok: null,
  error: null,
  already: null,
  url: null,
