  ...
  class Transcription < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'provider' => :'String',
        :'took_ms' => :'Integer',
        :'segments' => :'Array<TranscriptionSegmentsInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChatPanel::Transcription` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChatPanel::Transcription`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'took_ms')
        self.took_ms = attributes[:'took_ms']
      end
    ...
    def valid?
      ...
      task_validator = EnumAttributeValidator.new('String', ["transcribe"])
      return false unless task_validator.valid?(@task)
      provider_validator = EnumAttributeValidator.new('String', ["embedded", "remote", "container"])
    ...
    def task=(task)
      validator = EnumAttributeValidator.new('String', ["transcribe"])
    ...
    def provider=(provider)
      validator = EnumAttributeValidator.new('String', ["embedded", "remote", "container"])
    ...
    def hash
      [text, task, language, duration, provider, took_ms, segments].hash
    end
