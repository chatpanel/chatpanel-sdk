  ...
  class AgentCard < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChatPanel::AgentCard` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChatPanel::AgentCard`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'supported_interfaces')
        if (value = attributes[:'supported_interfaces']).is_a?(Array)
          self.supported_interfaces = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          version == o.version &&
          supported_interfaces == o.supported_interfaces &&
          provider == o.provider &&
    ...
    def hash
      [name, description, version, supported_interfaces, provider, capabilities, default_input_modes, default_output_modes, skills, icon_url, documentation_url].hash
    end
