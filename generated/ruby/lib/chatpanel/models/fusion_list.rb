...
module ChatPanel
  class FusionList < ApiModelBase
    attr_accessor :kinds

    attr_accessor :fusions
    ...
    def self.openapi_types
      {
        :'kinds' => :'Hash<String, FusionListKindsValue>',
        :'fusions' => :'Array<FusionListFusionsInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChatPanel::FusionList` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChatPanel::FusionList`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'kinds')
        if (value = attributes[:'kinds']).is_a?(Hash)
          self.kinds = value
        end
      else
        self.kinds = nil
      ...
      if attributes.key?(:'fusions')
        if (value = attributes[:'fusions']).is_a?(Array)
          self.fusions = value
        end
      else
        self.fusions = nil
    ...
    def list_invalid_properties
      ...
      if @fusions.nil?
        invalid_properties.push('invalid value for "fusions", fusions cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @fusions.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] kinds Value to be assigned
    def kinds=(kinds)
      if kinds.nil?
        fail ArgumentError, 'kinds cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] fusions Value to be assigned
    def fusions=(fusions)
      if fusions.nil?
        fail ArgumentError, 'fusions cannot be nil'
      end
