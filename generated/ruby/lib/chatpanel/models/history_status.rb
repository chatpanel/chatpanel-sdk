...
module ChatPanel
  class HistoryStatus < ApiModelBase
    attr_accessor :ok
    ...
    def self.openapi_types
      {
        ...
        :'newest' => :'Integer',
        :'bytes' => :'Integer',
        :'lossless' => :'HistoryStatusLossless'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChatPanel::HistoryStatus` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChatPanel::HistoryStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [ok, size, newest, bytes, lossless].hash
    end
