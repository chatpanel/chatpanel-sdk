  ...
  class WhoAmI < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChatPanel::WhoAmI` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChatPanel::WhoAmI`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'trust')
        self.trust = attributes[:'trust']
      else
        self.trust = nil
      end

      if attributes.key?(:'paired')
        self.paired = attributes[:'paired']
      else
        self.paired = nil
      end
    ...
    def list_invalid_properties
      ...
      if @paired.nil?
        invalid_properties.push('invalid value for "paired", paired cannot be nil.')
      end
    ...
    def valid?
      ...
      trust_validator = EnumAttributeValidator.new('String', ["token", "pinned", "unpaired", "local", "web"])
      return false unless trust_validator.valid?(@trust)
      return false if @paired.nil?
    ...
    # @param [Object] trust Object to be assigned
    def trust=(trust)
      validator = EnumAttributeValidator.new('String', ["token", "pinned", "unpaired", "local", "web"])
      unless validator.valid?(trust)
        fail ArgumentError, "invalid value for \"trust\", must be one of #{validator.allowable_values}."
      end
      @trust = trust
    end

    # Custom attribute writer method with validation
    # @param [Object] paired Value to be assigned
    def paired=(paired)
      if paired.nil?
        fail ArgumentError, 'paired cannot be nil'
      end
