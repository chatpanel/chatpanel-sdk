...
module ChatPanel
  class AgentCardCapabilities < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChatPanel::AgentCardCapabilities` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChatPanel::AgentCardCapabilities`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'extended_agent_card')
        self.extended_agent_card = attributes[:'extended_agent_card']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          extended_agent_card == o.extended_agent_card
    end
    ...
    def hash
      [streaming, push_notifications, extended_agent_card].hash
    end
