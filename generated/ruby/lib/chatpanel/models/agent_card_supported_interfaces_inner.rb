...
module ChatPanel
  class AgentCardSupportedInterfacesInner < ApiModelBase
    attr_accessor :url
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChatPanel::AgentCardSupportedInterfacesInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChatPanel::AgentCardSupportedInterfacesInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'protocol_binding')
        self.protocol_binding = attributes[:'protocol_binding']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          url == o.url &&
          protocol_binding == o.protocol_binding &&
    ...
    def hash
      [url, protocol_binding, protocol_version, tenant].hash
    end
