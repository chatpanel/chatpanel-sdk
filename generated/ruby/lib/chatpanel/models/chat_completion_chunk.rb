...
module ChatPanel
  ...
  class ChatCompletionChunk < ApiModelBase
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'object' => :'String',
        :'model' => :'String',
        :'choices' => :'Array<ChatCompletionChunkChoicesInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChatPanel::ChatCompletionChunk` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChatPanel::ChatCompletionChunk`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, object, model, choices, usage].hash
    end
