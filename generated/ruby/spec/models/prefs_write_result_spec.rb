...
# Unit tests for ChatPanel::PrefsWriteResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::PrefsWriteResult do
  #let(:instance) { ChatPanel::PrefsWriteResult.new }

  describe 'test an instance of PrefsWriteResult' do
    it 'should create an instance of PrefsWriteResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::PrefsWriteResult)
    end
  end
  ...
  describe 'test attribute "kept"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
