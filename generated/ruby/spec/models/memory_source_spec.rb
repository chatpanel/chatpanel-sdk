...
# Unit tests for ChatPanel::MemorySource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::MemorySource do
  #let(:instance) { ChatPanel::MemorySource.new }

  describe 'test an instance of MemorySource' do
    it 'should create an instance of MemorySource' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::MemorySource)
    end
  end
