...
# Unit tests for ChatPanel::TeamsStreamEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TeamsStreamEvent do
  #let(:instance) { ChatPanel::TeamsStreamEvent.new }

  describe 'test an instance of TeamsStreamEvent' do
    it 'should create an instance of TeamsStreamEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TeamsStreamEvent)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["hello", "run"])
