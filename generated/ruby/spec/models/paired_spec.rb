...
# Unit tests for ChatPanel::Paired
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::Paired do
  #let(:instance) { ChatPanel::Paired.new }

  describe 'test an instance of Paired' do
    it 'should create an instance of Paired' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::Paired)
    end
  end
  ...
  describe 'test attribute "bridge_token"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
