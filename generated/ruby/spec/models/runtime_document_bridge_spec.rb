...
# Unit tests for ChatPanel::RuntimeDocumentBridge
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RuntimeDocumentBridge do
  #let(:instance) { ChatPanel::RuntimeDocumentBridge.new }

  describe 'test an instance of RuntimeDocumentBridge' do
    it 'should create an instance of RuntimeDocumentBridge' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RuntimeDocumentBridge)
    end
  end
