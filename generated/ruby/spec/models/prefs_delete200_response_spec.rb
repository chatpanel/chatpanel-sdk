...
# Unit tests for ChatPanel::PrefsDelete200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::PrefsDelete200Response do
  #let(:instance) { ChatPanel::PrefsDelete200Response.new }

  describe 'test an instance of PrefsDelete200Response' do
    it 'should create an instance of PrefsDelete200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::PrefsDelete200Response)
    end
  end
