...
# Unit tests for ChatPanel::PutRecordsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::PutRecordsRequest do
  #let(:instance) { ChatPanel::PutRecordsRequest.new }

  describe 'test an instance of PutRecordsRequest' do
    it 'should create an instance of PutRecordsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::PutRecordsRequest)
    end
  end
