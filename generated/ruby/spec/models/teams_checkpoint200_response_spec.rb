...
# Unit tests for ChatPanel::TeamsCheckpoint200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TeamsCheckpoint200Response do
  #let(:instance) { ChatPanel::TeamsCheckpoint200Response.new }

  describe 'test an instance of TeamsCheckpoint200Response' do
    it 'should create an instance of TeamsCheckpoint200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TeamsCheckpoint200Response)
    end
  end
