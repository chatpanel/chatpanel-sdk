...
# Unit tests for ChatPanel::RememberResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RememberResponse do
  #let(:instance) { ChatPanel::RememberResponse.new }

  describe 'test an instance of RememberResponse' do
    it 'should create an instance of RememberResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RememberResponse)
    end
  end
  ...
  describe 'test attribute "replaced"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
