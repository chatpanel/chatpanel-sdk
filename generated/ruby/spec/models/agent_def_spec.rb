...
# Unit tests for ChatPanel::AgentDef
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentDef do
  #let(:instance) { ChatPanel::AgentDef.new }

  describe 'test an instance of AgentDef' do
    it 'should create an instance of AgentDef' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentDef)
    end
  end
  ...
  describe 'test attribute "writable"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "prompt_chars"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
