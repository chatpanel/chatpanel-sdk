...
# Unit tests for ChatPanel::ChatMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ChatMessage do
  #let(:instance) { ChatPanel::ChatMessage.new }

  describe 'test an instance of ChatMessage' do
    it 'should create an instance of ChatMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ChatMessage)
    end
  end
