...
# Unit tests for ChatPanel::PutRecordsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::PutRecordsResponse do
  #let(:instance) { ChatPanel::PutRecordsResponse.new }

  describe 'test an instance of PutRecordsResponse' do
    it 'should create an instance of PutRecordsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::PutRecordsResponse)
    end
  end
  ...
  describe 'test attribute "written"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
