...
# Unit tests for ChatPanel::PushEventsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::PushEventsResponse do
  #let(:instance) { ChatPanel::PushEventsResponse.new }

  describe 'test an instance of PushEventsResponse' do
    it 'should create an instance of PushEventsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::PushEventsResponse)
    end
  end
  ...
  describe 'test attribute "appended"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
