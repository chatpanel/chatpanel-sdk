...
# Unit tests for ChatPanel::TeamsPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TeamsPostRequest do
  #let(:instance) { ChatPanel::TeamsPostRequest.new }

  describe 'test an instance of TeamsPostRequest' do
    it 'should create an instance of TeamsPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TeamsPostRequest)
    end
  end
