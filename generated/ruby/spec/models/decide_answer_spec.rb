...
# Unit tests for ChatPanel::DecideAnswer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::DecideAnswer do
  #let(:instance) { ChatPanel::DecideAnswer.new }

  describe 'test an instance of DecideAnswer' do
    it 'should create an instance of DecideAnswer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::DecideAnswer)
    end
  end
