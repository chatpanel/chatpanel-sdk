...
# Unit tests for ChatPanel::TeamsListRuns200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TeamsListRuns200Response do
  #let(:instance) { ChatPanel::TeamsListRuns200Response.new }

  describe 'test an instance of TeamsListRuns200Response' do
    it 'should create an instance of TeamsListRuns200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TeamsListRuns200Response)
    end
  end
