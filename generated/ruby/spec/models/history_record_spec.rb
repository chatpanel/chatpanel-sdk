...
# Unit tests for ChatPanel::HistoryRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::HistoryRecord do
  #let(:instance) { ChatPanel::HistoryRecord.new }

  describe 'test an instance of HistoryRecord' do
    it 'should create an instance of HistoryRecord' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::HistoryRecord)
    end
  end
