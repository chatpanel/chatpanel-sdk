...
# Unit tests for ChatPanel::AgentCardSupportedInterfacesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentCardSupportedInterfacesInner do
  #let(:instance) { ChatPanel::AgentCardSupportedInterfacesInner.new }

  describe 'test an instance of AgentCardSupportedInterfacesInner' do
    it 'should create an instance of AgentCardSupportedInterfacesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentCardSupportedInterfacesInner)
    end
  end
  ...
  describe 'test attribute "protocol_binding"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
