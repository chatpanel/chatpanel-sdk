...
# Unit tests for ChatPanel::FusionList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::FusionList do
  #let(:instance) { ChatPanel::FusionList.new }

  describe 'test an instance of FusionList' do
    it 'should create an instance of FusionList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::FusionList)
    end
  end
  ...
  describe 'test attribute "fusions"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
