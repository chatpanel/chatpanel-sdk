...
# Unit tests for ChatPanel::SearchHit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::SearchHit do
  #let(:instance) { ChatPanel::SearchHit.new }

  describe 'test an instance of SearchHit' do
    it 'should create an instance of SearchHit' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::SearchHit)
    end
  end
