...
# Unit tests for ChatPanel::SmartSearchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::SmartSearchRequest do
  #let(:instance) { ChatPanel::SmartSearchRequest.new }

  describe 'test an instance of SmartSearchRequest' do
    it 'should create an instance of SmartSearchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::SmartSearchRequest)
    end
  end
  ...
  describe 'test attribute "max_queries"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
