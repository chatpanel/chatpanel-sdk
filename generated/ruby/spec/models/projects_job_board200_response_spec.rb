...
# Unit tests for ChatPanel::ProjectsJobBoard200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ProjectsJobBoard200Response do
  #let(:instance) { ChatPanel::ProjectsJobBoard200Response.new }

  describe 'test an instance of ProjectsJobBoard200Response' do
    it 'should create an instance of ProjectsJobBoard200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ProjectsJobBoard200Response)
    end
  end
