...
# Unit tests for ChatPanel::AgentExportRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentExportRequest do
  #let(:instance) { ChatPanel::AgentExportRequest.new }

  describe 'test an instance of AgentExportRequest' do
    it 'should create an instance of AgentExportRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentExportRequest)
    end
  end
  ...
  describe 'test attribute "to"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["claude", "codex", "chatpanel"])
