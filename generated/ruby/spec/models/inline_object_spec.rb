...
# Unit tests for ChatPanel::InlineObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::InlineObject do
  #let(:instance) { ChatPanel::InlineObject.new }

  describe 'test an instance of InlineObject' do
    it 'should create an instance of InlineObject' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::InlineObject)
    end
  end
