...
# Unit tests for ChatPanel::PrefsEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::PrefsEvent do
  #let(:instance) { ChatPanel::PrefsEvent.new }

  describe 'test an instance of PrefsEvent' do
    it 'should create an instance of PrefsEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::PrefsEvent)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["hello", "changed"])
