...
# Unit tests for ChatPanel::ProjectsList200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ProjectsList200Response do
  #let(:instance) { ChatPanel::ProjectsList200Response.new }

  describe 'test an instance of ProjectsList200Response' do
    it 'should create an instance of ProjectsList200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ProjectsList200Response)
    end
  end
