...
# Unit tests for ChatPanel::QuarantinedSkill
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::QuarantinedSkill do
  #let(:instance) { ChatPanel::QuarantinedSkill.new }

  describe 'test an instance of QuarantinedSkill' do
    it 'should create an instance of QuarantinedSkill' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::QuarantinedSkill)
    end
  end
  ...
  describe 'test attribute "verdict"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["suspicious", "dangerous"])
