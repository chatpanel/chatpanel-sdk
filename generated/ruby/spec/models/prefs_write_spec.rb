...
# Unit tests for ChatPanel::PrefsWrite
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::PrefsWrite do
  #let(:instance) { ChatPanel::PrefsWrite.new }

  describe 'test an instance of PrefsWrite' do
    it 'should create an instance of PrefsWrite' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::PrefsWrite)
    end
  end
