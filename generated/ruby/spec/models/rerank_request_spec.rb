...
# Unit tests for ChatPanel::RerankRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RerankRequest do
  #let(:instance) { ChatPanel::RerankRequest.new }

  describe 'test an instance of RerankRequest' do
    it 'should create an instance of RerankRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RerankRequest)
    end
  end
  ...
  describe 'test attribute "top_n"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
