...
# Unit tests for ChatPanel::RetrievalSearchAlias200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RetrievalSearchAlias200Response do
  #let(:instance) { ChatPanel::RetrievalSearchAlias200Response.new }

  describe 'test an instance of RetrievalSearchAlias200Response' do
    it 'should create an instance of RetrievalSearchAlias200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RetrievalSearchAlias200Response)
    end
  end
