...
# Unit tests for ChatPanel::MemoryList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::MemoryList do
  #let(:instance) { ChatPanel::MemoryList.new }

  describe 'test an instance of MemoryList' do
    it 'should create an instance of MemoryList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::MemoryList)
    end
  end
