...
# Unit tests for ChatPanel::RuntimeEngineRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RuntimeEngineRequest do
  #let(:instance) { ChatPanel::RuntimeEngineRequest.new }

  describe 'test an instance of RuntimeEngineRequest' do
    it 'should create an instance of RuntimeEngineRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RuntimeEngineRequest)
    end
  end
