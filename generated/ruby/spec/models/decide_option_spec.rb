...
# Unit tests for ChatPanel::DecideOption
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::DecideOption do
  #let(:instance) { ChatPanel::DecideOption.new }

  describe 'test an instance of DecideOption' do
    it 'should create an instance of DecideOption' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::DecideOption)
    end
  end
