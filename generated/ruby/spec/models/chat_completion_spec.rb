...
# Unit tests for ChatPanel::ChatCompletion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ChatCompletion do
  #let(:instance) { ChatPanel::ChatCompletion.new }

  describe 'test an instance of ChatCompletion' do
    it 'should create an instance of ChatCompletion' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ChatCompletion)
    end
  end
