...
# Unit tests for ChatPanel::TeamsAppendRunEventsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TeamsAppendRunEventsRequest do
  #let(:instance) { ChatPanel::TeamsAppendRunEventsRequest.new }

  describe 'test an instance of TeamsAppendRunEventsRequest' do
    it 'should create an instance of TeamsAppendRunEventsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TeamsAppendRunEventsRequest)
    end
  end
