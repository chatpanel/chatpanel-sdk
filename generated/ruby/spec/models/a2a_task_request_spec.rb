...
# Unit tests for ChatPanel::A2aTaskRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::A2aTaskRequest do
  #let(:instance) { ChatPanel::A2aTaskRequest.new }

  describe 'test an instance of A2aTaskRequest' do
    it 'should create an instance of A2aTaskRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::A2aTaskRequest)
    end
  end
