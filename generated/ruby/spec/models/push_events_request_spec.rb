...
# Unit tests for ChatPanel::PushEventsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::PushEventsRequest do
  #let(:instance) { ChatPanel::PushEventsRequest.new }

  describe 'test an instance of PushEventsRequest' do
    it 'should create an instance of PushEventsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::PushEventsRequest)
    end
  end
