...
# Unit tests for ChatPanel::AgentsGetDef200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentsGetDef200Response do
  #let(:instance) { ChatPanel::AgentsGetDef200Response.new }

  describe 'test an instance of AgentsGetDef200Response' do
    it 'should create an instance of AgentsGetDef200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentsGetDef200Response)
    end
  end
  ...
  describe 'test attribute "dialect"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["chatpanel", "claude", "codex", "a2a"])
      # validator.allowable_values.each do |value|
      #   expect { instance.dialect = value }.not_to raise_error
      # end
    end
  end
