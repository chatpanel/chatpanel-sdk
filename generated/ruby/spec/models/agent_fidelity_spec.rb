...
# Unit tests for ChatPanel::AgentFidelity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentFidelity do
  #let(:instance) { ChatPanel::AgentFidelity.new }

  describe 'test an instance of AgentFidelity' do
    it 'should create an instance of AgentFidelity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentFidelity)
    end
  end
  ...
  describe 'test attribute "lossless"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "carried"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
