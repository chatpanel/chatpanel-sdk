...
# Unit tests for ChatPanel::TeamRunCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TeamRunCreate do
  #let(:instance) { ChatPanel::TeamRunCreate.new }

  describe 'test an instance of TeamRunCreate' do
    it 'should create an instance of TeamRunCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TeamRunCreate)
    end
  end
