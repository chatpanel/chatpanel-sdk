...
# Unit tests for ChatPanel::EventsStreamEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::EventsStreamEvent do
  #let(:instance) { ChatPanel::EventsStreamEvent.new }

  describe 'test an instance of EventsStreamEvent' do
    it 'should create an instance of EventsStreamEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::EventsStreamEvent)
    end
  end
  ...
  describe 'test attribute "event"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["hello", "cloudevent"])
