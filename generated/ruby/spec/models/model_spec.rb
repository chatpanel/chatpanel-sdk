...
# Unit tests for ChatPanel::Model
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::Model do
  #let(:instance) { ChatPanel::Model.new }

  describe 'test an instance of Model' do
    it 'should create an instance of Model' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::Model)
    end
  end
  ...
  describe 'test attribute "provider_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["agent", "openai", "anthropic"])
      # validator.allowable_values.each do |value|
