...
# Unit tests for ChatPanel::RememberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RememberRequest do
  #let(:instance) { ChatPanel::RememberRequest.new }

  describe 'test an instance of RememberRequest' do
    it 'should create an instance of RememberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RememberRequest)
    end
  end
