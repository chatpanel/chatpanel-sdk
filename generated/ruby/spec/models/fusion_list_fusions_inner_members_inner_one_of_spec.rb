...
# Unit tests for ChatPanel::FusionListFusionsInnerMembersInnerOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::FusionListFusionsInnerMembersInnerOneOf do
  #let(:instance) { ChatPanel::FusionListFusionsInnerMembersInnerOneOf.new }

  describe 'test an instance of FusionListFusionsInnerMembersInnerOneOf' do
    it 'should create an instance of FusionListFusionsInnerMembersInnerOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::FusionListFusionsInnerMembersInnerOneOf)
    end
  end
  ...
  describe 'test attribute "role"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["target", "draft"])
