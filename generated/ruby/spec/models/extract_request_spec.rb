...
# Unit tests for ChatPanel::ExtractRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ExtractRequest do
  #let(:instance) { ChatPanel::ExtractRequest.new }

  describe 'test an instance of ExtractRequest' do
    it 'should create an instance of ExtractRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ExtractRequest)
    end
  end
