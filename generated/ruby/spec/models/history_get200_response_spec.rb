...
# Unit tests for ChatPanel::HistoryGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::HistoryGet200Response do
  #let(:instance) { ChatPanel::HistoryGet200Response.new }

  describe 'test an instance of HistoryGet200Response' do
    it 'should create an instance of HistoryGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::HistoryGet200Response)
    end
  end
