...
# Unit tests for ChatPanel::WebSearchResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::WebSearchResult do
  #let(:instance) { ChatPanel::WebSearchResult.new }

  describe 'test an instance of WebSearchResult' do
    it 'should create an instance of WebSearchResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::WebSearchResult)
    end
  end
