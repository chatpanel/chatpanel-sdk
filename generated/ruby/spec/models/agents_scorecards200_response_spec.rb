...
# Unit tests for ChatPanel::AgentsScorecards200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentsScorecards200Response do
  #let(:instance) { ChatPanel::AgentsScorecards200Response.new }

  describe 'test an instance of AgentsScorecards200Response' do
    it 'should create an instance of AgentsScorecards200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentsScorecards200Response)
    end
  end
