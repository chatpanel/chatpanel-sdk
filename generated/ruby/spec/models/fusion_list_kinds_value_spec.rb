...
# Unit tests for ChatPanel::FusionListKindsValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::FusionListKindsValue do
  #let(:instance) { ChatPanel::FusionListKindsValue.new }

  describe 'test an instance of FusionListKindsValue' do
    it 'should create an instance of FusionListKindsValue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::FusionListKindsValue)
    end
  end
  ...
  describe 'test attribute "gain"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["recall", "speed", "reliability"])
      # validator.allowable_values.each do |value|
      #   expect { instance.gain = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "what"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
