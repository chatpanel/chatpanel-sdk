...
# Unit tests for ChatPanel::RerankResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RerankResponse do
  #let(:instance) { ChatPanel::RerankResponse.new }

  describe 'test an instance of RerankResponse' do
    it 'should create an instance of RerankResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RerankResponse)
    end
  end
