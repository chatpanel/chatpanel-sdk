...
# Unit tests for ChatPanel::AgentsRateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentsRateRequest do
  #let(:instance) { ChatPanel::AgentsRateRequest.new }

  describe 'test an instance of AgentsRateRequest' do
    it 'should create an instance of AgentsRateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentsRateRequest)
    end
  end
