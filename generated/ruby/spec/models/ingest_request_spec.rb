...
# Unit tests for ChatPanel::IngestRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::IngestRequest do
  #let(:instance) { ChatPanel::IngestRequest.new }

  describe 'test an instance of IngestRequest' do
    it 'should create an instance of IngestRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::IngestRequest)
    end
  end
