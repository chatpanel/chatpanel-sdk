...
# Unit tests for ChatPanel::ExtractResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ExtractResponse do
  #let(:instance) { ChatPanel::ExtractResponse.new }

  describe 'test an instance of ExtractResponse' do
    it 'should create an instance of ExtractResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ExtractResponse)
    end
  end
