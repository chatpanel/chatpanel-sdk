...
# Unit tests for ChatPanel::SkillsGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::SkillsGet200Response do
  #let(:instance) { ChatPanel::SkillsGet200Response.new }

  describe 'test an instance of SkillsGet200Response' do
    it 'should create an instance of SkillsGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::SkillsGet200Response)
    end
  end
