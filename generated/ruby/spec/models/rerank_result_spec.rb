...
# Unit tests for ChatPanel::RerankResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RerankResult do
  #let(:instance) { ChatPanel::RerankResult.new }

  describe 'test an instance of RerankResult' do
    it 'should create an instance of RerankResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RerankResult)
    end
  end
  ...
  describe 'test attribute "relevance_score"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
