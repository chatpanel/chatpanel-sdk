...
# Unit tests for ChatPanel::TeamRun
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TeamRun do
  #let(:instance) { ChatPanel::TeamRun.new }

  describe 'test an instance of TeamRun' do
    it 'should create an instance of TeamRun' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TeamRun)
    end
  end
