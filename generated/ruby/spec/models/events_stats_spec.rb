...
# Unit tests for ChatPanel::EventsStats
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::EventsStats do
  #let(:instance) { ChatPanel::EventsStats.new }

  describe 'test an instance of EventsStats' do
    it 'should create an instance of EventsStats' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::EventsStats)
    end
  end
