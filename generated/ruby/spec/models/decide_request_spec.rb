...
# Unit tests for ChatPanel::DecideRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::DecideRequest do
  #let(:instance) { ChatPanel::DecideRequest.new }

  describe 'test an instance of DecideRequest' do
    it 'should create an instance of DecideRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::DecideRequest)
    end
  end
