...
# Unit tests for ChatPanel::AgentsExportDef200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentsExportDef200Response do
  #let(:instance) { ChatPanel::AgentsExportDef200Response.new }

  describe 'test an instance of AgentsExportDef200Response' do
    it 'should create an instance of AgentsExportDef200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentsExportDef200Response)
    end
  end
  ...
  describe 'test attribute "backed_up"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["new", "ours", "theirs"])
