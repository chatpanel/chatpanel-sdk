...
# Unit tests for ChatPanel::DetectedEntity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::DetectedEntity do
  #let(:instance) { ChatPanel::DetectedEntity.new }

  describe 'test an instance of DetectedEntity' do
    it 'should create an instance of DetectedEntity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::DetectedEntity)
    end
  end
