...
# Unit tests for ChatPanel::CapabilitiesDocumentServer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::CapabilitiesDocumentServer do
  #let(:instance) { ChatPanel::CapabilitiesDocumentServer.new }

  describe 'test an instance of CapabilitiesDocumentServer' do
    it 'should create an instance of CapabilitiesDocumentServer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::CapabilitiesDocumentServer)
    end
  end
