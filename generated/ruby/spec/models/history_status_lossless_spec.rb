...
# Unit tests for ChatPanel::HistoryStatusLossless
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::HistoryStatusLossless do
  #let(:instance) { ChatPanel::HistoryStatusLossless.new }

  describe 'test an instance of HistoryStatusLossless' do
    it 'should create an instance of HistoryStatusLossless' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::HistoryStatusLossless)
    end
  end
