...
# Unit tests for ChatPanel::ChatContentPart
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ChatContentPart do
  #let(:instance) { ChatPanel::ChatContentPart.new }

  describe 'test an instance of ChatContentPart' do
    it 'should create an instance of ChatContentPart' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ChatContentPart)
    end
  end
