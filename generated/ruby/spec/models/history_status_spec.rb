...
# Unit tests for ChatPanel::HistoryStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::HistoryStatus do
  #let(:instance) { ChatPanel::HistoryStatus.new }

  describe 'test an instance of HistoryStatus' do
    it 'should create an instance of HistoryStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::HistoryStatus)
    end
  end
