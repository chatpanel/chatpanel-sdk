...
# Unit tests for ChatPanel::SearchResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::SearchResponse do
  #let(:instance) { ChatPanel::SearchResponse.new }

  describe 'test an instance of SearchResponse' do
    it 'should create an instance of SearchResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::SearchResponse)
    end
  end
