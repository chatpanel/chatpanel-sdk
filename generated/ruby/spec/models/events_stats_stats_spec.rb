...
# Unit tests for ChatPanel::EventsStatsStats
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::EventsStatsStats do
  #let(:instance) { ChatPanel::EventsStatsStats.new }

  describe 'test an instance of EventsStatsStats' do
    it 'should create an instance of EventsStatsStats' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::EventsStatsStats)
    end
  end
  ...
  describe 'test attribute "avg_bytes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "turns"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
