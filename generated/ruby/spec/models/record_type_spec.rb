...
# Unit tests for ChatPanel::RecordType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RecordType do
  #let(:instance) { ChatPanel::RecordType.new }

  describe 'test an instance of RecordType' do
    it 'should create an instance of RecordType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RecordType)
    end
  end
