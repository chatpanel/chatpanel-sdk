...
# Unit tests for ChatPanel::PairingCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::PairingCode do
  #let(:instance) { ChatPanel::PairingCode.new }

  describe 'test an instance of PairingCode' do
    it 'should create an instance of PairingCode' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::PairingCode)
    end
  end
