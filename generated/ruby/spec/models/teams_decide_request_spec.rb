...
# Unit tests for ChatPanel::TeamsDecideRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TeamsDecideRequest do
  #let(:instance) { ChatPanel::TeamsDecideRequest.new }

  describe 'test an instance of TeamsDecideRequest' do
    it 'should create an instance of TeamsDecideRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TeamsDecideRequest)
    end
  end
