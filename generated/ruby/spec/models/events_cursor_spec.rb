...
# Unit tests for ChatPanel::EventsCursor
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::EventsCursor do
  #let(:instance) { ChatPanel::EventsCursor.new }

  describe 'test an instance of EventsCursor' do
    it 'should create an instance of EventsCursor' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::EventsCursor)
    end
  end
