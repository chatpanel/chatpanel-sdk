...
# Unit tests for ChatPanel::Transcription
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::Transcription do
  #let(:instance) { ChatPanel::Transcription.new }

  describe 'test an instance of Transcription' do
    it 'should create an instance of Transcription' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::Transcription)
    end
  end
  ...
  describe 'test attribute "task"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["transcribe"])
  ...
  describe 'test attribute "provider"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["embedded", "remote", "container"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "took_ms"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
