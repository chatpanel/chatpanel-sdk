...
# Unit tests for ChatPanel::AgentExportPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentExportPlan do
  #let(:instance) { ChatPanel::AgentExportPlan.new }

  describe 'test an instance of AgentExportPlan' do
    it 'should create an instance of AgentExportPlan' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentExportPlan)
    end
  end
