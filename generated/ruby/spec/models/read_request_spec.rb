...
# Unit tests for ChatPanel::ReadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ReadRequest do
  #let(:instance) { ChatPanel::ReadRequest.new }

  describe 'test an instance of ReadRequest' do
    it 'should create an instance of ReadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ReadRequest)
    end
  end
  ...
  describe 'test attribute "format"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["markdown", "text"])
  ...
  describe 'test attribute "max_chars"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
