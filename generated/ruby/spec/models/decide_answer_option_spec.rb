...
# Unit tests for ChatPanel::DecideAnswerOption
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::DecideAnswerOption do
  #let(:instance) { ChatPanel::DecideAnswerOption.new }

  describe 'test an instance of DecideAnswerOption' do
    it 'should create an instance of DecideAnswerOption' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::DecideAnswerOption)
    end
  end
