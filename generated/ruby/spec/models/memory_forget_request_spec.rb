...
# Unit tests for ChatPanel::MemoryForgetRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::MemoryForgetRequest do
  #let(:instance) { ChatPanel::MemoryForgetRequest.new }

  describe 'test an instance of MemoryForgetRequest' do
    it 'should create an instance of MemoryForgetRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::MemoryForgetRequest)
    end
  end
