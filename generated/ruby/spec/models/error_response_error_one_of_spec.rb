...
# Unit tests for ChatPanel::ErrorResponseErrorOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ErrorResponseErrorOneOf do
  #let(:instance) { ChatPanel::ErrorResponseErrorOneOf.new }

  describe 'test an instance of ErrorResponseErrorOneOf' do
    it 'should create an instance of ErrorResponseErrorOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ErrorResponseErrorOneOf)
    end
  end
