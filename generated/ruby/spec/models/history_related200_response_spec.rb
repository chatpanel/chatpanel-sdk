...
# Unit tests for ChatPanel::HistoryRelated200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::HistoryRelated200Response do
  #let(:instance) { ChatPanel::HistoryRelated200Response.new }

  describe 'test an instance of HistoryRelated200Response' do
    it 'should create an instance of HistoryRelated200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::HistoryRelated200Response)
    end
  end
