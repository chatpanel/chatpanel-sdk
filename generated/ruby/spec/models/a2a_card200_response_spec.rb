...
# Unit tests for ChatPanel::A2aCard200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::A2aCard200Response do
  #let(:instance) { ChatPanel::A2aCard200Response.new }

  describe 'test an instance of A2aCard200Response' do
    it 'should create an instance of A2aCard200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::A2aCard200Response)
    end
  end
