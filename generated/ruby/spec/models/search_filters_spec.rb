...
# Unit tests for ChatPanel::SearchFilters
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::SearchFilters do
  #let(:instance) { ChatPanel::SearchFilters.new }

  describe 'test an instance of SearchFilters' do
    it 'should create an instance of SearchFilters' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::SearchFilters)
    end
  end
