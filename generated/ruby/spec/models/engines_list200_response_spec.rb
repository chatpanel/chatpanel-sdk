...
# Unit tests for ChatPanel::EnginesList200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::EnginesList200Response do
  #let(:instance) { ChatPanel::EnginesList200Response.new }

  describe 'test an instance of EnginesList200Response' do
    it 'should create an instance of EnginesList200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::EnginesList200Response)
    end
  end
