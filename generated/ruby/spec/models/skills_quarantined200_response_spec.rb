...
# Unit tests for ChatPanel::SkillsQuarantined200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::SkillsQuarantined200Response do
  #let(:instance) { ChatPanel::SkillsQuarantined200Response.new }

  describe 'test an instance of SkillsQuarantined200Response' do
    it 'should create an instance of SkillsQuarantined200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::SkillsQuarantined200Response)
    end
  end
