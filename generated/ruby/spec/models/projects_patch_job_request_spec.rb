...
# Unit tests for ChatPanel::ProjectsPatchJobRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ProjectsPatchJobRequest do
  #let(:instance) { ChatPanel::ProjectsPatchJobRequest.new }

  describe 'test an instance of ProjectsPatchJobRequest' do
    it 'should create an instance of ProjectsPatchJobRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ProjectsPatchJobRequest)
    end
  end
