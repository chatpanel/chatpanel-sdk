...
# Unit tests for ChatPanel::ProjectsCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ProjectsCreateRequest do
  #let(:instance) { ChatPanel::ProjectsCreateRequest.new }

  describe 'test an instance of ProjectsCreateRequest' do
    it 'should create an instance of ProjectsCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ProjectsCreateRequest)
    end
  end
