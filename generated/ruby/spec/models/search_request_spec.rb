...
# Unit tests for ChatPanel::SearchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::SearchRequest do
  #let(:instance) { ChatPanel::SearchRequest.new }

  describe 'test an instance of SearchRequest' do
    it 'should create an instance of SearchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::SearchRequest)
    end
  end
