...
# Unit tests for ChatPanel::A2ASendRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::A2ASendRequest do
  #let(:instance) { ChatPanel::A2ASendRequest.new }

  describe 'test an instance of A2ASendRequest' do
    it 'should create an instance of A2ASendRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::A2ASendRequest)
    end
  end
  ...
  describe 'test attribute "return_immediately"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
