...
# Unit tests for ChatPanel::PrefSection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::PrefSection do
  #let(:instance) { ChatPanel::PrefSection.new }

  describe 'test an instance of PrefSection' do
    it 'should create an instance of PrefSection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::PrefSection)
    end
  end
