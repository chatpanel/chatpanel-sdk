...
# Unit tests for ChatPanel::AudioSpeechRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AudioSpeechRequest do
  #let(:instance) { ChatPanel::AudioSpeechRequest.new }

  describe 'test an instance of AudioSpeechRequest' do
    it 'should create an instance of AudioSpeechRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AudioSpeechRequest)
    end
  end
  ...
  describe 'test attribute "response_format"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["wav"])
