...
# Unit tests for ChatPanel::Health
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::Health do
  #let(:instance) { ChatPanel::Health.new }

  describe 'test an instance of Health' do
    it 'should create an instance of Health' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::Health)
    end
  end
  ...
  describe 'test attribute "pairing"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "stt"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
