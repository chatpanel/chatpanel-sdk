...
# Unit tests for ChatPanel::ReadResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ReadResponse do
  #let(:instance) { ChatPanel::ReadResponse.new }

  describe 'test an instance of ReadResponse' do
    it 'should create an instance of ReadResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ReadResponse)
    end
  end
