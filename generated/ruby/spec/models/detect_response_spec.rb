...
# Unit tests for ChatPanel::DetectResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::DetectResponse do
  #let(:instance) { ChatPanel::DetectResponse.new }

  describe 'test an instance of DetectResponse' do
    it 'should create an instance of DetectResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::DetectResponse)
    end
  end
