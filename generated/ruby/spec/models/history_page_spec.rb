...
# Unit tests for ChatPanel::HistoryPage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::HistoryPage do
  #let(:instance) { ChatPanel::HistoryPage.new }

  describe 'test an instance of HistoryPage' do
    it 'should create an instance of HistoryPage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::HistoryPage)
    end
  end
