...
# Unit tests for ChatPanel::ChatCompletionChunk
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ChatCompletionChunk do
  #let(:instance) { ChatPanel::ChatCompletionChunk.new }

  describe 'test an instance of ChatCompletionChunk' do
    it 'should create an instance of ChatCompletionChunk' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ChatCompletionChunk)
    end
  end
