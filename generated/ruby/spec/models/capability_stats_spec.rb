...
# Unit tests for ChatPanel::CapabilityStats
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::CapabilityStats do
  #let(:instance) { ChatPanel::CapabilityStats.new }

  describe 'test an instance of CapabilityStats' do
    it 'should create an instance of CapabilityStats' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::CapabilityStats)
    end
  end
  ...
  describe 'test attribute "last_ms"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "chars_per_sec"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
