...
# Unit tests for ChatPanel::TeamsClaimRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TeamsClaimRequest do
  #let(:instance) { ChatPanel::TeamsClaimRequest.new }

  describe 'test an instance of TeamsClaimRequest' do
    it 'should create an instance of TeamsClaimRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TeamsClaimRequest)
    end
  end
