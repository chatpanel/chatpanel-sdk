...
# Unit tests for ChatPanel::RecallRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RecallRequest do
  #let(:instance) { ChatPanel::RecallRequest.new }

  describe 'test an instance of RecallRequest' do
    it 'should create an instance of RecallRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RecallRequest)
    end
  end
