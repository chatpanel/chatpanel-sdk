...
# Unit tests for ChatPanel::SkillsList200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::SkillsList200Response do
  #let(:instance) { ChatPanel::SkillsList200Response.new }

  describe 'test an instance of SkillsList200Response' do
    it 'should create an instance of SkillsList200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::SkillsList200Response)
    end
  end
