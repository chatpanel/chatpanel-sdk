...
# Unit tests for ChatPanel::HistoryItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::HistoryItem do
  #let(:instance) { ChatPanel::HistoryItem.new }

  describe 'test an instance of HistoryItem' do
    it 'should create an instance of HistoryItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::HistoryItem)
    end
  end
