...
# Unit tests for ChatPanel::EventsPage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::EventsPage do
  #let(:instance) { ChatPanel::EventsPage.new }

  describe 'test an instance of EventsPage' do
    it 'should create an instance of EventsPage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::EventsPage)
    end
  end
