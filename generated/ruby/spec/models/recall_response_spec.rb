...
# Unit tests for ChatPanel::RecallResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RecallResponse do
  #let(:instance) { ChatPanel::RecallResponse.new }

  describe 'test an instance of RecallResponse' do
    it 'should create an instance of RecallResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RecallResponse)
    end
  end
