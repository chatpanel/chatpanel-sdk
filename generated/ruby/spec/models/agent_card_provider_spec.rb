...
# Unit tests for ChatPanel::AgentCardProvider
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentCardProvider do
  #let(:instance) { ChatPanel::AgentCardProvider.new }

  describe 'test an instance of AgentCardProvider' do
    it 'should create an instance of AgentCardProvider' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentCardProvider)
    end
  end
