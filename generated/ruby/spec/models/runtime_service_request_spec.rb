...
# Unit tests for ChatPanel::RuntimeServiceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RuntimeServiceRequest do
  #let(:instance) { ChatPanel::RuntimeServiceRequest.new }

  describe 'test an instance of RuntimeServiceRequest' do
    it 'should create an instance of RuntimeServiceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RuntimeServiceRequest)
    end
  end
  ...
  describe 'test attribute "action"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["start", "stop", "model"])
