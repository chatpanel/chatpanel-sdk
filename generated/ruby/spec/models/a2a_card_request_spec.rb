...
# Unit tests for ChatPanel::A2aCardRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::A2aCardRequest do
  #let(:instance) { ChatPanel::A2aCardRequest.new }

  describe 'test an instance of A2aCardRequest' do
    it 'should create an instance of A2aCardRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::A2aCardRequest)
    end
  end
  ...
  describe 'test attribute "forget"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
