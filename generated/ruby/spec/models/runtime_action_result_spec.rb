...
# Unit tests for ChatPanel::RuntimeActionResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RuntimeActionResult do
  #let(:instance) { ChatPanel::RuntimeActionResult.new }

  describe 'test an instance of RuntimeActionResult' do
    it 'should create an instance of RuntimeActionResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RuntimeActionResult)
    end
  end
  ...
  describe 'test attribute "already"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "answering"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "restarted"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
