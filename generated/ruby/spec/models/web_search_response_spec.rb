...
# Unit tests for ChatPanel::WebSearchResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::WebSearchResponse do
  #let(:instance) { ChatPanel::WebSearchResponse.new }

  describe 'test an instance of WebSearchResponse' do
    it 'should create an instance of WebSearchResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::WebSearchResponse)
    end
  end
  ...
  describe 'test attribute "unresponsive"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "redacted"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
