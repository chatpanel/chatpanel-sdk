...
# Unit tests for ChatPanel::HistoryStreamEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::HistoryStreamEvent do
  #let(:instance) { ChatPanel::HistoryStreamEvent.new }

  describe 'test an instance of HistoryStreamEvent' do
    it 'should create an instance of HistoryStreamEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::HistoryStreamEvent)
    end
  end
  ...
  describe 'test attribute "event"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["hello", "records"])
