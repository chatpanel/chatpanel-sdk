...
# Unit tests for ChatPanel::MemorySyncResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::MemorySyncResponse do
  #let(:instance) { ChatPanel::MemorySyncResponse.new }

  describe 'test an instance of MemorySyncResponse' do
    it 'should create an instance of MemorySyncResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::MemorySyncResponse)
    end
  end
  ...
  describe 'test attribute "memories"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
