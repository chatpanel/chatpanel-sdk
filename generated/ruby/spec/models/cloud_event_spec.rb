...
# Unit tests for ChatPanel::CloudEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::CloudEvent do
  #let(:instance) { ChatPanel::CloudEvent.new }

  describe 'test an instance of CloudEvent' do
    it 'should create an instance of CloudEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::CloudEvent)
    end
  end
  ...
  describe 'test attribute "specversion"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["1.0"])
      # validator.allowable_values.each do |value|
      #   expect { instance.specversion = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "chatpanelv"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
