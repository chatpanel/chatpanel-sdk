...
# Unit tests for ChatPanel::WhoAmI
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::WhoAmI do
  #let(:instance) { ChatPanel::WhoAmI.new }

  describe 'test an instance of WhoAmI' do
    it 'should create an instance of WhoAmI' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::WhoAmI)
    end
  end
  ...
  describe 'test attribute "trust"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["token", "pinned", "unpaired", "local", "web"])
      # validator.allowable_values.each do |value|
      #   expect { instance.trust = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "paired"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
