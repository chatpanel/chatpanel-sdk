...
# Unit tests for ChatPanel::GatewayPairRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::GatewayPairRequest do
  #let(:instance) { ChatPanel::GatewayPairRequest.new }

  describe 'test an instance of GatewayPairRequest' do
    it 'should create an instance of GatewayPairRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::GatewayPairRequest)
    end
  end
