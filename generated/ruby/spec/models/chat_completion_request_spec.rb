...
# Unit tests for ChatPanel::ChatCompletionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ChatCompletionRequest do
  #let(:instance) { ChatPanel::ChatCompletionRequest.new }

  describe 'test an instance of ChatCompletionRequest' do
    it 'should create an instance of ChatCompletionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ChatCompletionRequest)
    end
  end
