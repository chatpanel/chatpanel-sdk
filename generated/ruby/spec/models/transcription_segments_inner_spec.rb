...
# Unit tests for ChatPanel::TranscriptionSegmentsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TranscriptionSegmentsInner do
  #let(:instance) { ChatPanel::TranscriptionSegmentsInner.new }

  describe 'test an instance of TranscriptionSegmentsInner' do
    it 'should create an instance of TranscriptionSegmentsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TranscriptionSegmentsInner)
    end
  end
