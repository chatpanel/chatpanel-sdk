...
# Unit tests for ChatPanel::ReadRestriction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ReadRestriction do
  #let(:instance) { ChatPanel::ReadRestriction.new }

  describe 'test an instance of ReadRestriction' do
    it 'should create an instance of ReadRestriction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ReadRestriction)
    end
  end
  ...
  describe 'test attribute "reason"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["login", "paywall", "rate_limited", "robots", "tdm"])
