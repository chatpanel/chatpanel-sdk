...
# Unit tests for ChatPanel::ModelList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ModelList do
  #let(:instance) { ChatPanel::ModelList.new }

  describe 'test an instance of ModelList' do
    it 'should create an instance of ModelList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ModelList)
    end
  end
