...
# Unit tests for ChatPanel::RedactionPreview
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RedactionPreview do
  #let(:instance) { ChatPanel::RedactionPreview.new }

  describe 'test an instance of RedactionPreview' do
    it 'should create an instance of RedactionPreview' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RedactionPreview)
    end
  end
  ...
  describe 'test attribute "sanitized"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "tier"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["basic", "full"])
