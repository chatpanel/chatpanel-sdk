...
# Unit tests for ChatPanel::FusionListFusionsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::FusionListFusionsInner do
  #let(:instance) { ChatPanel::FusionListFusionsInner.new }

  describe 'test an instance of FusionListFusionsInner' do
    it 'should create an instance of FusionListFusionsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::FusionListFusionsInner)
    end
  end
  ...
  describe 'test attribute "kind"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["union", "draft", "fallback"])
  ...
  describe 'test attribute "describe"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
