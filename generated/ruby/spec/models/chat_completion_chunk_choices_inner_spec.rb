...
# Unit tests for ChatPanel::ChatCompletionChunkChoicesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ChatCompletionChunkChoicesInner do
  #let(:instance) { ChatPanel::ChatCompletionChunkChoicesInner.new }

  describe 'test an instance of ChatCompletionChunkChoicesInner' do
    it 'should create an instance of ChatCompletionChunkChoicesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ChatCompletionChunkChoicesInner)
    end
  end
