...
# Unit tests for ChatPanel::RedactionPreviewRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RedactionPreviewRequest do
  #let(:instance) { ChatPanel::RedactionPreviewRequest.new }

  describe 'test an instance of RedactionPreviewRequest' do
    it 'should create an instance of RedactionPreviewRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RedactionPreviewRequest)
    end
  end
