...
# Unit tests for ChatPanel::AgentsListDefs200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentsListDefs200Response do
  #let(:instance) { ChatPanel::AgentsListDefs200Response.new }

  describe 'test an instance of AgentsListDefs200Response' do
    it 'should create an instance of AgentsListDefs200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentsListDefs200Response)
    end
  end
