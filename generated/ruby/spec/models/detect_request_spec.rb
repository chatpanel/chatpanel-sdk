...
# Unit tests for ChatPanel::DetectRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::DetectRequest do
  #let(:instance) { ChatPanel::DetectRequest.new }

  describe 'test an instance of DetectRequest' do
    it 'should create an instance of DetectRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::DetectRequest)
    end
  end
