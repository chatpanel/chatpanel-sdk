...
# Unit tests for ChatPanel::ProjectsPostJobRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ProjectsPostJobRequest do
  #let(:instance) { ChatPanel::ProjectsPostJobRequest.new }

  describe 'test an instance of ProjectsPostJobRequest' do
    it 'should create an instance of ProjectsPostJobRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ProjectsPostJobRequest)
    end
  end
