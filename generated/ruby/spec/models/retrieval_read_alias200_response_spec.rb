...
# Unit tests for ChatPanel::RetrievalReadAlias200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RetrievalReadAlias200Response do
  #let(:instance) { ChatPanel::RetrievalReadAlias200Response.new }

  describe 'test an instance of RetrievalReadAlias200Response' do
    it 'should create an instance of RetrievalReadAlias200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RetrievalReadAlias200Response)
    end
  end
