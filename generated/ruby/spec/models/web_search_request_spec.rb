...
# Unit tests for ChatPanel::WebSearchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::WebSearchRequest do
  #let(:instance) { ChatPanel::WebSearchRequest.new }

  describe 'test an instance of WebSearchRequest' do
    it 'should create an instance of WebSearchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::WebSearchRequest)
    end
  end
  ...
  describe 'test attribute "budget_ms"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
