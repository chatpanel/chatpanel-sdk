...
# Unit tests for ChatPanel::HistoryIngest200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::HistoryIngest200Response do
  #let(:instance) { ChatPanel::HistoryIngest200Response.new }

  describe 'test an instance of HistoryIngest200Response' do
    it 'should create an instance of HistoryIngest200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::HistoryIngest200Response)
    end
  end
