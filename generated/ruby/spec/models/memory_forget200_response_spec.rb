...
# Unit tests for ChatPanel::MemoryForget200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::MemoryForget200Response do
  #let(:instance) { ChatPanel::MemoryForget200Response.new }

  describe 'test an instance of MemoryForget200Response' do
    it 'should create an instance of MemoryForget200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::MemoryForget200Response)
    end
  end
