...
# Unit tests for ChatPanel::TeamsAnswerRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TeamsAnswerRequest do
  #let(:instance) { ChatPanel::TeamsAnswerRequest.new }

  describe 'test an instance of TeamsAnswerRequest' do
    it 'should create an instance of TeamsAnswerRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TeamsAnswerRequest)
    end
  end
