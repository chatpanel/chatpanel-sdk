...
# Unit tests for ChatPanel::ReadSection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ReadSection do
  #let(:instance) { ChatPanel::ReadSection.new }

  describe 'test an instance of ReadSection' do
    it 'should create an instance of ReadSection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ReadSection)
    end
  end
