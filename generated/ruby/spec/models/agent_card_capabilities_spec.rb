...
# Unit tests for ChatPanel::AgentCardCapabilities
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentCardCapabilities do
  #let(:instance) { ChatPanel::AgentCardCapabilities.new }

  describe 'test an instance of AgentCardCapabilities' do
    it 'should create an instance of AgentCardCapabilities' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentCardCapabilities)
    end
  end
  ...
  describe 'test attribute "extended_agent_card"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
