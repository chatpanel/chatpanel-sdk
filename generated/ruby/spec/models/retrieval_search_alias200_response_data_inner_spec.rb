...
# Unit tests for ChatPanel::RetrievalSearchAlias200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RetrievalSearchAlias200ResponseDataInner do
  #let(:instance) { ChatPanel::RetrievalSearchAlias200ResponseDataInner.new }

  describe 'test an instance of RetrievalSearchAlias200ResponseDataInner' do
    it 'should create an instance of RetrievalSearchAlias200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RetrievalSearchAlias200ResponseDataInner)
    end
  end
