...
# Unit tests for ChatPanel::MemorySyncRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::MemorySyncRequest do
  #let(:instance) { ChatPanel::MemorySyncRequest.new }

  describe 'test an instance of MemorySyncRequest' do
    it 'should create an instance of MemorySyncRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::MemorySyncRequest)
    end
  end

  describe 'test attribute "upserts"' do
    it 'should work' do
