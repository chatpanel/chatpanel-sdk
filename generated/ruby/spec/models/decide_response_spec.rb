...
# Unit tests for ChatPanel::DecideResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::DecideResponse do
  #let(:instance) { ChatPanel::DecideResponse.new }

  describe 'test an instance of DecideResponse' do
    it 'should create an instance of DecideResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::DecideResponse)
    end
  end
  ...
  describe 'test attribute "calibrated"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
