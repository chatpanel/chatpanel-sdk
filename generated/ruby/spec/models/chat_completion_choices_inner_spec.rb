...
# Unit tests for ChatPanel::ChatCompletionChoicesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ChatCompletionChoicesInner do
  #let(:instance) { ChatPanel::ChatCompletionChoicesInner.new }

  describe 'test an instance of ChatCompletionChoicesInner' do
    it 'should create an instance of ChatCompletionChoicesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ChatCompletionChoicesInner)
    end
  end
