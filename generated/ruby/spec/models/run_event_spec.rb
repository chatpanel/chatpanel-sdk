...
# Unit tests for ChatPanel::RunEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RunEvent do
  #let(:instance) { ChatPanel::RunEvent.new }

  describe 'test an instance of RunEvent' do
    it 'should create an instance of RunEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RunEvent)
    end
  end
