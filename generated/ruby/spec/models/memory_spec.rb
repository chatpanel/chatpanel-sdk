...
# Unit tests for ChatPanel::Memory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::Memory do
  #let(:instance) { ChatPanel::Memory.new }

  describe 'test an instance of Memory' do
    it 'should create an instance of Memory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::Memory)
    end
  end
