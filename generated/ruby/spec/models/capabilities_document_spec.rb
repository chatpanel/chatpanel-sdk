...
# Unit tests for ChatPanel::CapabilitiesDocument
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::CapabilitiesDocument do
  #let(:instance) { ChatPanel::CapabilitiesDocument.new }

  describe 'test an instance of CapabilitiesDocument' do
    it 'should create an instance of CapabilitiesDocument' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::CapabilitiesDocument)
    end
  end
