...
# Unit tests for ChatPanel::DecideQuestion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::DecideQuestion do
  #let(:instance) { ChatPanel::DecideQuestion.new }

  describe 'test an instance of DecideQuestion' do
    it 'should create an instance of DecideQuestion' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::DecideQuestion)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["choice", "score", "noul"])
