...
# Unit tests for ChatPanel::RuntimeDocument
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::RuntimeDocument do
  #let(:instance) { ChatPanel::RuntimeDocument.new }

  describe 'test an instance of RuntimeDocument' do
    it 'should create an instance of RuntimeDocument' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::RuntimeDocument)
    end
  end
  ...
  describe 'test attribute "refused"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "in_process"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
