...
# Unit tests for ChatPanel::IngestRequestUpsertsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::IngestRequestUpsertsInner do
  #let(:instance) { ChatPanel::IngestRequestUpsertsInner.new }

  describe 'test an instance of IngestRequestUpsertsInner' do
    it 'should create an instance of IngestRequestUpsertsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::IngestRequestUpsertsInner)
    end
  end
