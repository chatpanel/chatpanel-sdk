...
# Unit tests for ChatPanel::AgentFidelityDroppedInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::AgentFidelityDroppedInner do
  #let(:instance) { ChatPanel::AgentFidelityDroppedInner.new }

  describe 'test an instance of AgentFidelityDroppedInner' do
    it 'should create an instance of AgentFidelityDroppedInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::AgentFidelityDroppedInner)
    end
  end
