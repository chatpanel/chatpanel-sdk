...
# Unit tests for ChatPanel::TeamsHandoffRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::TeamsHandoffRequest do
  #let(:instance) { ChatPanel::TeamsHandoffRequest.new }

  describe 'test an instance of TeamsHandoffRequest' do
    it 'should create an instance of TeamsHandoffRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::TeamsHandoffRequest)
    end
  end
