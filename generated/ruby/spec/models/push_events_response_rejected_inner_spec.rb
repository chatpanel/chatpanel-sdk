...
# Unit tests for ChatPanel::PushEventsResponseRejectedInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::PushEventsResponseRejectedInner do
  #let(:instance) { ChatPanel::PushEventsResponseRejectedInner.new }

  describe 'test an instance of PushEventsResponseRejectedInner' do
    it 'should create an instance of PushEventsResponseRejectedInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::PushEventsResponseRejectedInner)
    end
  end
