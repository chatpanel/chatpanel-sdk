...
# Unit tests for ChatPanel::SmartSearchResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::SmartSearchResponse do
  #let(:instance) { ChatPanel::SmartSearchResponse.new }

  describe 'test an instance of SmartSearchResponse' do
    it 'should create an instance of SmartSearchResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::SmartSearchResponse)
    end
  end
