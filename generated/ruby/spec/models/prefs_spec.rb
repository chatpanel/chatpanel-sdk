...
# Unit tests for ChatPanel::Prefs
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::Prefs do
  #let(:instance) { ChatPanel::Prefs.new }

  describe 'test an instance of Prefs' do
    it 'should create an instance of Prefs' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::Prefs)
    end
  end
