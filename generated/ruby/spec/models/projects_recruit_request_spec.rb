...
# Unit tests for ChatPanel::ProjectsRecruitRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ChatPanel::ProjectsRecruitRequest do
  #let(:instance) { ChatPanel::ProjectsRecruitRequest.new }

  describe 'test an instance of ProjectsRecruitRequest' do
    it 'should create an instance of ProjectsRecruitRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ChatPanel::ProjectsRecruitRequest)
    end
  end
  ...
  describe 'test attribute "chat_model"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
