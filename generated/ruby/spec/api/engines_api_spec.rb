...
# Unit tests for ChatPanel::EnginesApi
...
describe 'EnginesApi' do
  ...
  describe 'test an instance of EnginesApi' do
    it 'should create an instance of EnginesApi' do
      expect(@api_instance).to be_instance_of(ChatPanel::EnginesApi)
    end
  end

  # unit tests for engines_append_entry
  # Append a ledger entry for an engine.
  # @param engine_key 
  # @param request_body 
  # @param [Hash] opts the optional parameters
  # @return [Hash<String, Object>]
  describe 'engines_append_entry test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for engines_card
  ...
  # @return [Hash<String, Object>]
  describe 'engines_card test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for engines_list
  # Every engine&#39;s card.
  # @param [Hash] opts the optional parameters
  # @option opts [Integer] :min_calls 
  # @return [EnginesList200Response]
  describe 'engines_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
