...
# Unit tests for ChatPanel::RuntimeApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RuntimeApi' do
  before do
  ...
  describe 'test an instance of RuntimeApi' do
    it 'should create an instance of RuntimeApi' do
      expect(@api_instance).to be_instance_of(ChatPanel::RuntimeApi)
    end
  end

  # unit tests for runtime_engine
  ...
  describe 'runtime_engine test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for runtime_service
  ...
  # @return [RuntimeActionResult]
  describe 'runtime_service test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for runtime_status
  ...
  describe 'runtime_status test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
