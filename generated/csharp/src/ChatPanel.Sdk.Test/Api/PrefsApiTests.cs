...
{
    /// <summary>
    ///  Class for testing PrefsApi
    /// </summary>
    public sealed class PrefsApiTests : ApiTestsBase
    {
        private readonly IPrefsApi _instance;

        public PrefsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IPrefsApi>();
        }
        ...
        public async Task PrefsDeleteAsyncTest()
        {
            string section = default!;
            var response = await _instance.PrefsDeleteAsync(section);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task PrefsEventsAsyncTest()
        {
            var response = await _instance.PrefsEventsAsync();
            var model = response.Ok();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task PrefsGetAsyncTest()
        {
            Client.Option<string> section = default!;
            Client.Option<bool> stamps = default!;
            var response = await _instance.PrefsGetAsync(section, stamps);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.Prefs>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task PrefsPutAsyncTest()
        {
            PrefsWrite prefsWrite = default!;
            var response = await _instance.PrefsPutAsync(prefsWrite);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.PrefsWriteResult>(model);
        }
    }
}
