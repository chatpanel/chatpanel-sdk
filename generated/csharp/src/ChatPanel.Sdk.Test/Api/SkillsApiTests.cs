...
namespace ChatPanel.Sdk.Test.Api
{
    ...
    /// </summary>
    public sealed class SkillsApiTests : ApiTestsBase
    {
        private readonly ISkillsApi _instance;

        public SkillsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISkillsApi>();
        }
        ...
        public async Task SkillsGetAsyncTest()
        {
            string skillId = default!;
            Client.Option<string> workdir = default!;
            var response = await _instance.SkillsGetAsync(skillId, workdir);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.SkillsGet200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task SkillsListAsyncTest()
        {
            Client.Option<string> workdir = default!;
            var response = await _instance.SkillsListAsync(workdir);
            var model = response.Ok();
