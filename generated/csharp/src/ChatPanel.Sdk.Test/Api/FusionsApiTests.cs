...
{
    /// <summary>
    ///  Class for testing FusionsApi
    /// </summary>
    public sealed class FusionsApiTests : ApiTestsBase
    {
        private readonly IFusionsApi _instance;

        public FusionsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IFusionsApi>();
        }
        ...
        public async Task FusionsListAsyncTest()
        {
            var response = await _instance.FusionsListAsync();
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.FusionList>(model);
        }
    }
}
