...
namespace ChatPanel.Sdk.Test.Api
{
    ...
    /// </summary>
    public sealed class EnginesApiTests : ApiTestsBase
    {
        private readonly IEnginesApi _instance;

        public EnginesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IEnginesApi>();
        }

        /// <summary>
        /// Test EnginesAppendEntry
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task EnginesAppendEntryAsyncTest()
        {
            string engineKey = default!;
            Dictionary<string, Object> requestBody = default!;
            var response = await _instance.EnginesAppendEntryAsync(engineKey, requestBody);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task EnginesCardAsyncTest()
        {
            string engineKey = default!;
            Client.Option<bool> entries = default!;
            Client.Option<int> minCalls = default!;
            var response = await _instance.EnginesCardAsync(engineKey, entries, minCalls);
            var model = response.Ok();
            Assert.IsType<Dictionary<string, Object>>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task EnginesListAsyncTest()
        {
            Client.Option<int> minCalls = default!;
            var response = await _instance.EnginesListAsync(minCalls);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.EnginesList200Response>(model);
        }
    }
}
