...
namespace ChatPanel.Sdk.Test.Api
{
    ...
    public sealed class ChatApiTests : ApiTestsBase
    {
        ...
        public async Task ChatCompletionsAsyncTest()
        {
            ...
            Client.Option<string> xChatPanelRedaction = default!;
            Client.Option<string> xChatPanelRun = default!;
            var response = await _instance.ChatCompletionsAsync(chatCompletionRequest, xChatPanelRedaction, xChatPanelRun);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.ChatCompletion>(model);
        }
    }
}
