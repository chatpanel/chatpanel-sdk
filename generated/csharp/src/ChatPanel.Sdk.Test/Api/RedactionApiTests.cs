...
{
    /// <summary>
    ///  Class for testing RedactionApi
    /// </summary>
    public sealed class RedactionApiTests : ApiTestsBase
    {
        private readonly IRedactionApi _instance;

        public RedactionApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IRedactionApi>();
        }

        /// <summary>
        /// Test RedactionPreview
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RedactionPreviewAsyncTest()
        {
            RedactionPreviewRequest redactionPreviewRequest = default!;
            var response = await _instance.RedactionPreviewAsync(redactionPreviewRequest);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.RedactionPreview>(model);
        }
    }
}
