...
namespace ChatPanel.Sdk.Test.Api
{
    ...
    /// </summary>
    public sealed class RuntimeApiTests : ApiTestsBase
    {
        private readonly IRuntimeApi _instance;

        public RuntimeApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IRuntimeApi>();
        }
        ...
        public async Task RuntimeEngineAsyncTest()
        {
            string name = default!;
            Client.Option<RuntimeEngineRequest> runtimeEngineRequest = default!;
            var response = await _instance.RuntimeEngineAsync(name, runtimeEngineRequest);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.RuntimeActionResult>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RuntimeServiceAsyncTest()
        {
            string id = default!;
            Client.Option<RuntimeServiceRequest> runtimeServiceRequest = default!;
            var response = await _instance.RuntimeServiceAsync(id, runtimeServiceRequest);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.RuntimeActionResult>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RuntimeStatusAsyncTest()
        {
            var response = await _instance.RuntimeStatusAsync();
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.RuntimeDocument>(model);
        }
    }
}
