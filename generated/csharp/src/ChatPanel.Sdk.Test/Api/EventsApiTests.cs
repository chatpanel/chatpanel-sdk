...
namespace ChatPanel.Sdk.Test.Api
{
    ...
    public sealed class EventsApiTests : ApiTestsBase
    {
        ...
        public async Task EventsCursorAsyncTest()
        {
            var response = await _instance.EventsCursorAsync();
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.EventsCursor>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task EventsPushAsyncTest()
        {
            PushEventsRequest pushEventsRequest = default!;
            var response = await _instance.EventsPushAsync(pushEventsRequest);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.PushEventsResponse>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task EventsSinceAsyncTest()
        {
            Client.Option<string> cursor = default!;
            Client.Option<int> limit = default!;
            Client.Option<string> host = default!;
            var response = await _instance.EventsSinceAsync(cursor, limit, host);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.EventsPage>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task EventsStatsAsyncTest()
        {
            var response = await _instance.EventsStatsAsync();
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.EventsStats>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task EventsStreamAsyncTest()
        {
            Client.Option<string> cursor = default!;
            var response = await _instance.EventsStreamAsync(cursor);
            var model = response.Ok();
