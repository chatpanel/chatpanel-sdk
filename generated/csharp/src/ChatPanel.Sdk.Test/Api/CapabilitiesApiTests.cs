...
namespace ChatPanel.Sdk.Test.Api
{
    ...
    public sealed class CapabilitiesApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test CapabilitiesDecide
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CapabilitiesDecideAsyncTest()
        {
            DecideRequest decideRequest = default!;
            var response = await _instance.CapabilitiesDecideAsync(decideRequest);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.DecideResponse>(model);
        }

        /// <summary>
        /// Test CapabilitiesDetect
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CapabilitiesDetectAsyncTest()
        {
            DetectRequest detectRequest = default!;
            var response = await _instance.CapabilitiesDetectAsync(detectRequest);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.DetectResponse>(model);
        }

        /// <summary>
        /// Test CapabilitiesList
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CapabilitiesListAsyncTest()
        {
            var response = await _instance.CapabilitiesListAsync();
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.CapabilitiesDocument>(model);
        }

        /// <summary>
        /// Test CapabilitiesRerank
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CapabilitiesRerankAsyncTest()
        {
            RerankRequest rerankRequest = default!;
            var response = await _instance.CapabilitiesRerankAsync(rerankRequest);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.RerankResponse>(model);
        }
    }
}
