...
namespace ChatPanel.Sdk.Test.Api
{
    ...
    public sealed class AudioApiTests : ApiTestsBase
    {
        ...
        public async Task AudioSpeechAsyncTest()
        {
            AudioSpeechRequest audioSpeechRequest = default!;
            var response = await _instance.AudioSpeechAsync(audioSpeechRequest);
            var model = response.Ok();
            Assert.IsType<System.IO.Stream>(model);
        }

        /// <summary>
        /// Test AudioTranscribe
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AudioTranscribeAsyncTest()
        {
            ChatPanel.Sdk.Client.FileParameter file = default!;
            Client.Option<string> model = default!;
            Client.Option<string> language = default!;
            Client.Option<string> responseFormat = default!;
            Client.Option<string> diarize = default!;
            var response = await _instance.AudioTranscribeAsync(file, model, language, responseFormat, diarize);
            var model = response.Ok();
            Assert.IsType<ChatPanel.Sdk.Model.Transcription>(model);
        }
    }
}
