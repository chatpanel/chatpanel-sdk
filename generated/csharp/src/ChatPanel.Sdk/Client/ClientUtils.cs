...
[assembly: InternalsVisibleTo("ChatPanel.Sdk.Test")]
...
namespace ChatPanel.Sdk.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string ApiKeyHeaderToString(ApiKeyHeader value)
        {
            return value switch
            {
                ApiKeyHeader.X_ChatPanel_Token => "X-ChatPanel-Token",
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Capability.IdEnum capabilityIdEnum)
                return Capability.IdEnumToJsonValue(capabilityIdEnum);
            if (obj is ChatMessage.RoleEnum chatMessageRoleEnum)
                return ChatMessage.RoleEnumToJsonValue(chatMessageRoleEnum);
            if (obj is CloudEvent.SpecversionEnum cloudEventSpecversionEnum)
                return CloudEvent.SpecversionEnumToJsonValue(cloudEventSpecversionEnum);
            if (obj is DecideQuestion.TypeEnum decideQuestionTypeEnum)
                return DecideQuestion.TypeEnumToJsonValue(decideQuestionTypeEnum);
            if (obj is EventsStreamEvent.EventEnum eventsStreamEventEventEnum)
                return EventsStreamEvent.EventEnumToJsonValue(eventsStreamEventEventEnum);
            if (obj is FusionListFusionsInner.KindEnum fusionListFusionsInnerKindEnum)
                return FusionListFusionsInner.KindEnumToJsonValue(fusionListFusionsInnerKindEnum);
            if (obj is FusionListFusionsInnerMembersInnerOneOf.RoleEnum fusionListFusionsInnerMembersInnerOneOfRoleEnum)
                return FusionListFusionsInnerMembersInnerOneOf.RoleEnumToJsonValue(fusionListFusionsInnerMembersInnerOneOfRoleEnum);
            if (obj is FusionListKindsValue.GainEnum fusionListKindsValueGainEnum)
                return FusionListKindsValue.GainEnumToJsonValue(fusionListKindsValueGainEnum);
            if (obj is Health.TierEnum healthTierEnum)
                return Health.TierEnumToJsonValue(healthTierEnum);
            if (obj is HistoryStreamEvent.EventEnum historyStreamEventEventEnum)
                return HistoryStreamEvent.EventEnumToJsonValue(historyStreamEventEventEnum);
            ...
            if (obj is ReadResponse.FormatEnum readResponseFormatEnum)
                return ReadResponse.FormatEnumToJsonValue(readResponseFormatEnum);
            if (obj is ReadRestriction.ReasonEnum readRestrictionReasonEnum)
                return ReadRestriction.ReasonEnumToJsonValue(readRestrictionReasonEnum);
            ...
            if (obj is Transcription.ProviderEnum transcriptionProviderEnum)
                return Transcription.ProviderEnumToJsonValue(transcriptionProviderEnum);
            if (obj is WebSearchRequest.FreshnessEnum webSearchRequestFreshnessEnum)
                return WebSearchRequest.FreshnessEnumToJsonValue(webSearchRequestFreshnessEnum);
            if (obj is WhoAmI.TrustEnum whoAmITrustEnum)
                return WhoAmI.TrustEnumToJsonValue(whoAmITrustEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "http://127.0.0.1:4320";
