...
// checks if the TeamsAppendRunEventsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamsAppendRunEventsRequest{}

// TeamsAppendRunEventsRequest struct for TeamsAppendRunEventsRequest
type TeamsAppendRunEventsRequest struct {
	Events []RunEvent `json:"events"`
	AdditionalProperties map[string]interface{}
}

type _TeamsAppendRunEventsRequest TeamsAppendRunEventsRequest
...
func NewTeamsAppendRunEventsRequest(events []RunEvent) *TeamsAppendRunEventsRequest {
	this := TeamsAppendRunEventsRequest{}
	this.Events = events
	return &this
}
...
func (o TeamsAppendRunEventsRequest) MarshalJSON() ([]byte, error) {
...
func (o TeamsAppendRunEventsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *TeamsAppendRunEventsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamsAppendRunEventsRequest := _TeamsAppendRunEventsRequest{}

	err = json.Unmarshal(data, &varTeamsAppendRunEventsRequest)

	if err != nil {
		return err
	}

	*o = TeamsAppendRunEventsRequest(varTeamsAppendRunEventsRequest)
...
type NullableTeamsAppendRunEventsRequest struct {
	value *TeamsAppendRunEventsRequest
	isSet bool
}

func (v NullableTeamsAppendRunEventsRequest) Get() *TeamsAppendRunEventsRequest {
	return v.value
}

func (v *NullableTeamsAppendRunEventsRequest) Set(val *TeamsAppendRunEventsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamsAppendRunEventsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamsAppendRunEventsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamsAppendRunEventsRequest(val *TeamsAppendRunEventsRequest) *NullableTeamsAppendRunEventsRequest {
	return &NullableTeamsAppendRunEventsRequest{value: val, isSet: true}
}

func (v NullableTeamsAppendRunEventsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamsAppendRunEventsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
