...
// checks if the ProjectsPatchJobRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectsPatchJobRequest{}

// ProjectsPatchJobRequest struct for ProjectsPatchJobRequest
type ProjectsPatchJobRequest struct {
...
type _ProjectsPatchJobRequest ProjectsPatchJobRequest
...
func (o ProjectsPatchJobRequest) MarshalJSON() ([]byte, error) {
...
func (o ProjectsPatchJobRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectsPatchJobRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectsPatchJobRequest := _ProjectsPatchJobRequest{}

	err = json.Unmarshal(data, &varProjectsPatchJobRequest)

	if err != nil {
		return err
	}

	*o = ProjectsPatchJobRequest(varProjectsPatchJobRequest)
...
type NullableProjectsPatchJobRequest struct {
	value *ProjectsPatchJobRequest
	isSet bool
}

func (v NullableProjectsPatchJobRequest) Get() *ProjectsPatchJobRequest {
	return v.value
}

func (v *NullableProjectsPatchJobRequest) Set(val *ProjectsPatchJobRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectsPatchJobRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectsPatchJobRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectsPatchJobRequest(val *ProjectsPatchJobRequest) *NullableProjectsPatchJobRequest {
	return &NullableProjectsPatchJobRequest{value: val, isSet: true}
}

func (v NullableProjectsPatchJobRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectsPatchJobRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
