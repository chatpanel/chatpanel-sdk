...
// checks if the PrefsWrite type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrefsWrite{}

// PrefsWrite struct for PrefsWrite
type PrefsWrite struct {
	Sections map[string]PrefSection `json:"sections"`
	// Which client is writing.
	By *string `json:"by,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PrefsWrite PrefsWrite
...
func (o PrefsWrite) MarshalJSON() ([]byte, error) {
...
func (o PrefsWrite) ToMap() (map[string]interface{}, error) {
...
func (o *PrefsWrite) UnmarshalJSON(data []byte) (err error) {
	...
	varPrefsWrite := _PrefsWrite{}

	err = json.Unmarshal(data, &varPrefsWrite)

	if err != nil {
		return err
	}

	*o = PrefsWrite(varPrefsWrite)
...
type NullablePrefsWrite struct {
	value *PrefsWrite
	isSet bool
}

func (v NullablePrefsWrite) Get() *PrefsWrite {
	return v.value
}

func (v *NullablePrefsWrite) Set(val *PrefsWrite) {
	v.value = val
	v.isSet = true
}

func (v NullablePrefsWrite) IsSet() bool {
	return v.isSet
}

func (v *NullablePrefsWrite) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrefsWrite(val *PrefsWrite) *NullablePrefsWrite {
	return &NullablePrefsWrite{value: val, isSet: true}
}

func (v NullablePrefsWrite) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrefsWrite) UnmarshalJSON(src []byte) error {
	v.isSet = true
