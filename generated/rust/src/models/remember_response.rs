...
pub struct RememberResponse {
    ...
    pub action: String,
    #[serde(rename = "record")]
    pub record: models::Memory,
    #[serde(rename = "replaced", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub replaced: Option<Option<models::Memory>>,
    #[serde(rename = "size", skip_serializing_if = "Option::is_none")]
    pub size: Option<i32>,
}

impl RememberResponse {
    pub fn new(ok: bool, action: String, record: models::Memory) -> RememberResponse {
        RememberResponse {
            ok,
            action,
            record,
