...
pub struct RetrievalReadAlias200Response {
    #[serde(rename = "code")]
    pub code: i32,
    #[serde(rename = "status")]
    pub status: i32,
    #[serde(rename = "data")]
    pub data: Box<models::ReadResponse>,
}

impl RetrievalReadAlias200Response {
    pub fn new(code: i32, status: i32, data: models::ReadResponse) -> RetrievalReadAlias200Response {
