...
pub struct ProjectsJobBoard200Response {
    #[serde(rename = "ok")]
    pub ok: bool,
    #[serde(rename = "jobs")]
    pub jobs: Vec<std::collections::HashMap<String, serde_json::Value>>,
}

impl ProjectsJobBoard200Response {
    pub fn new(ok: bool, jobs: Vec<std::collections::HashMap<String, serde_json::Value>>) -> ProjectsJobBoard200Response {
