...
pub struct TeamsListRuns200Response {
    #[serde(rename = "ok")]
    pub ok: bool,
    #[serde(rename = "runs")]
    pub runs: Vec<models::TeamRun>,
}

impl TeamsListRuns200Response {
    pub fn new(ok: bool, runs: Vec<models::TeamRun>) -> TeamsListRuns200Response {
