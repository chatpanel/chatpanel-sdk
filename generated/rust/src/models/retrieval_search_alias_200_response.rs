...
pub struct RetrievalSearchAlias200Response {
    #[serde(rename = "code")]
    pub code: i32,
    #[serde(rename = "status")]
    pub status: i32,
    #[serde(rename = "data")]
    pub data: Vec<models::RetrievalSearchAlias200ResponseDataInner>,
}

impl RetrievalSearchAlias200Response {
    pub fn new(code: i32, status: i32, data: Vec<models::RetrievalSearchAlias200ResponseDataInner>) -> RetrievalSearchAlias200Response {
