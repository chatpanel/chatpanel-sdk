...
pub struct EventsStats {
    ...
    pub ok: bool,
    #[serde(rename = "stats")]
    pub stats: models::EventsStatsStats,
    ...
    pub year: Option<Option<std::collections::HashMap<String, serde_json::Value>>>,
}

impl EventsStats {
    pub fn new(ok: bool, stats: models::EventsStatsStats) -> EventsStats {
        EventsStats {
            ok,
            stats,
            year: None,
