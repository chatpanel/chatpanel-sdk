...
pub struct RedactionPreview {
    ...
    #[serde(rename = "count")]
    pub count: i32,
    #[serde(rename = "sanitized", skip_serializing_if = "Option::is_none")]
    pub sanitized: Option<i32>,
    ...
    pub entities: Option<Vec<std::collections::HashMap<String, serde_json::Value>>>,
    ...
    pub detector: Option<std::collections::HashMap<String, serde_json::Value>>,
}

impl RedactionPreview {
    pub fn new(text: String, count: i32) -> RedactionPreview {
        RedactionPreview {
            text,
            count,
            sanitized: None,
