...
pub struct EnginesList200Response {
    #[serde(rename = "ok")]
    pub ok: bool,
    #[serde(rename = "engines")]
    pub engines: Vec<std::collections::HashMap<String, serde_json::Value>>,
}

impl EnginesList200Response {
    pub fn new(ok: bool, engines: Vec<std::collections::HashMap<String, serde_json::Value>>) -> EnginesList200Response {
