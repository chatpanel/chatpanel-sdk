...
pub struct FusionListFusionsInnerMembersInnerOneOf {
    #[serde(rename = "id")]
    pub id: String,
...
impl FusionListFusionsInnerMembersInnerOneOf {
    pub fn new(id: String) -> FusionListFusionsInnerMembersInnerOneOf {
