...
pub struct Prefs {
    ...
    pub sections: Option<std::collections::HashMap<String, models::PrefSection>>,
    #[serde(rename = "stamps", skip_serializing_if = "Option::is_none")]
    pub stamps: Option<std::collections::HashMap<String, i64>>,
}

impl Prefs {
    pub fn new(ok: bool, revision: i32) -> Prefs {
        Prefs {
            ok,
            revision,
            sections: None,
