...
pub struct HistoryGet200Response {
    #[serde(rename = "ok")]
    pub ok: bool,
    #[serde(rename = "record")]
    pub record: models::HistoryRecord,
}

impl HistoryGet200Response {
    pub fn new(ok: bool, record: models::HistoryRecord) -> HistoryGet200Response {
