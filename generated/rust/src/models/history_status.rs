...
pub struct HistoryStatus {
    ...
    #[serde(rename = "lossless", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub lossless: Option<Option<Box<models::HistoryStatusLossless>>>,
}

impl HistoryStatus {
    pub fn new(ok: bool, size: i32) -> HistoryStatus {
        HistoryStatus {
            ok,
            size,
            newest: None,
