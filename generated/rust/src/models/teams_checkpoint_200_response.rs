...
pub struct TeamsCheckpoint200Response {
    #[serde(rename = "ok")]
    pub ok: bool,
    /// A domain object whose shape is owned by `@chatpanel/events`; the SDK carries it as-is.
    #[serde(rename = "checkpoint")]
    pub checkpoint: std::collections::HashMap<String, serde_json::Value>,
}

impl TeamsCheckpoint200Response {
    pub fn new(ok: bool, checkpoint: std::collections::HashMap<String, serde_json::Value>) -> TeamsCheckpoint200Response {
