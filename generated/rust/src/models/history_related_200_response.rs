...
pub struct HistoryRelated200Response {
    #[serde(rename = "ok")]
    pub ok: bool,
    #[serde(rename = "results")]
    pub results: Vec<models::SearchHit>,
}

impl HistoryRelated200Response {
    pub fn new(ok: bool, results: Vec<models::SearchHit>) -> HistoryRelated200Response {
