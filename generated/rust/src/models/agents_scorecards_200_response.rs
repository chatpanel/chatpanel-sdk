...
pub struct AgentsScorecards200Response {
    #[serde(rename = "ok")]
    pub ok: bool,
    #[serde(rename = "agents")]
    pub agents: Vec<std::collections::HashMap<String, serde_json::Value>>,
}

impl AgentsScorecards200Response {
    pub fn new(ok: bool, agents: Vec<std::collections::HashMap<String, serde_json::Value>>) -> AgentsScorecards200Response {
