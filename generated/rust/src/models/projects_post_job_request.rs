...
pub struct ProjectsPostJobRequest {
    /// A domain object whose shape is owned by `@chatpanel/events`; the SDK carries it as-is.
    #[serde(rename = "job")]
    pub job: std::collections::HashMap<String, serde_json::Value>,
    #[serde(rename = "by", skip_serializing_if = "Option::is_none")]
    pub by: Option<String>,
}

impl ProjectsPostJobRequest {
    pub fn new(job: std::collections::HashMap<String, serde_json::Value>) -> ProjectsPostJobRequest {
