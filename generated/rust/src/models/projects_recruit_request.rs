...
pub struct ProjectsRecruitRequest {
    ...
    pub evaluation: Option<std::collections::HashMap<String, serde_json::Value>>,
    #[serde(rename = "text", skip_serializing_if = "Option::is_none")]
    pub text: Option<String>,
}

impl ProjectsRecruitRequest {
    pub fn new() -> ProjectsRecruitRequest {
