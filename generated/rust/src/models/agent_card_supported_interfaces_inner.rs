...
pub struct AgentCardSupportedInterfacesInner {
    #[serde(rename = "url", skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
    /// JSONRPC, GRPC, HTTP+JSON — an open string, so an unknown binding is carried.
    #[serde(rename = "protocolBinding", skip_serializing_if = "Option::is_none")]
...
impl AgentCardSupportedInterfacesInner {
    pub fn new() -> AgentCardSupportedInterfacesInner {
