...
pub struct SkillsQuarantined200Response {
    #[serde(rename = "quarantined")]
    pub quarantined: Vec<models::QuarantinedSkill>,
}

impl SkillsQuarantined200Response {
    pub fn new(quarantined: Vec<models::QuarantinedSkill>) -> SkillsQuarantined200Response {
