...
pub struct DecideRequest {
    ...
    pub questions: std::collections::HashMap<String, models::DecideQuestion>,
...
impl DecideRequest {
    pub fn new(state: String, questions: std::collections::HashMap<String, models::DecideQuestion>) -> DecideRequest {
        DecideRequest {
            state,
            questions,
            model: None,
