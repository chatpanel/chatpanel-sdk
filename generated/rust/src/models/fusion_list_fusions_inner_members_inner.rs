...
#[serde(untagged)]
pub enum FusionListFusionsInnerMembersInner {
    String(String),
    FusionListFusionsInnerMembersInnerOneOf(Box<models::FusionListFusionsInnerMembersInnerOneOf>),
}

impl Default for FusionListFusionsInnerMembersInner {
    fn default() -> Self {
