...
pub struct CapabilitiesDocument {
    ...
    #[serde(rename = "server")]
    pub server: Box<models::CapabilitiesDocumentServer>,
}

impl CapabilitiesDocument {
    pub fn new(capabilities: Vec<models::Capability>, server: models::CapabilitiesDocumentServer) -> CapabilitiesDocument {
