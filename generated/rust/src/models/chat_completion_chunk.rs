...
pub struct ChatCompletionChunk {
    ...
    pub choices: Vec<models::ChatCompletionChunkChoicesInner>,
...
impl ChatCompletionChunk {
    ...
    pub fn new(id: String, object: String, choices: Vec<models::ChatCompletionChunkChoicesInner>) -> ChatCompletionChunk {
        ChatCompletionChunk {
            id,
            object,
            model: None,
