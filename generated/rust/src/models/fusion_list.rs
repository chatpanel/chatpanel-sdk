...
pub struct FusionList {
    #[serde(rename = "kinds")]
    pub kinds: std::collections::HashMap<String, models::FusionListKindsValue>,
    #[serde(rename = "fusions")]
    pub fusions: Vec<models::FusionListFusionsInner>,
}

impl FusionList {
    pub fn new(kinds: std::collections::HashMap<String, models::FusionListKindsValue>, fusions: Vec<models::FusionListFusionsInner>) -> FusionList {
        FusionList {
            kinds,
            fusions,
        }
