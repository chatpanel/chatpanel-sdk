...
pub struct TeamsAppendRunEventsRequest {
    #[serde(rename = "events")]
    pub events: Vec<models::RunEvent>,
}

impl TeamsAppendRunEventsRequest {
    pub fn new(events: Vec<models::RunEvent>) -> TeamsAppendRunEventsRequest {
