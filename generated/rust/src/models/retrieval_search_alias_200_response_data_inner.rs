...
pub struct RetrievalSearchAlias200ResponseDataInner {
    #[serde(rename = "url")]
    pub url: String,
    #[serde(rename = "title")]
    pub title: String,
...
impl RetrievalSearchAlias200ResponseDataInner {
    pub fn new(url: String, title: String, description: String, content: String) -> RetrievalSearchAlias200ResponseDataInner {
