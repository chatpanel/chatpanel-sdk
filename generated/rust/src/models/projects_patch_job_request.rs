...
pub struct ProjectsPatchJobRequest {
...
impl ProjectsPatchJobRequest {
    pub fn new(patch: std::collections::HashMap<String, serde_json::Value>) -> ProjectsPatchJobRequest {
