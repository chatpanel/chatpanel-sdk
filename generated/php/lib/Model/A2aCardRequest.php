...
/**
 * A2aCardRequest Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class A2aCardRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'a2a_card_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('forget', $data ?? [], null);
     ...
     * Sets url
     *
     * @param string $url The agent's origin, or a card URL outright.
     *
     * @return self
     */
     ...
     * Sets force
     *
     * @param bool|null $force Skip the TTL and revalidate — the ETag is still sent.
     *
     * @return self
     */
    ...
    {
        return $this->container['forget'];
    }

    /**
     * Sets forget
     *
     * @param bool|null $forget Drop the cached card first.
     *
     * @return self
     */
    ...
    {
        if (is_null($forget)) {
            throw new \InvalidArgumentException('non-nullable forget cannot be null');
        }
        $this->container['forget'] = $forget;
     ...
     * Sets auth
     *
     * @param string|null $auth An Authorization header value for agents that need one.
     *
     * @return self
     */
