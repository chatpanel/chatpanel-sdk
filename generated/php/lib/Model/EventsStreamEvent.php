...
/**
 * EventsStreamEvent Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class EventsStreamEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EventsStreamEvent';
    ...
    public const EVENT_CLOUDEVENT = 'cloudevent';
     ...
     * Sets cursor
     *
     * @param array<string,int>|null $cursor `{ host: seq }` — the highest seq held per host.
     *
     * @return self
     */
