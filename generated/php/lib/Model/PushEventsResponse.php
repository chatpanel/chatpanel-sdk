 ...
 */
class PushEventsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'appended' => 'int',
        'duplicates' => 'int',
        'rejected' => '\ChatPanelSdk\Model\PushEventsResponseRejectedInner[]',
        'cursor' => 'array<string,int>'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('appended', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['appended'] === null) {
            $invalidProperties[] = "'appended' can't be null";
        }
    ...
    {
        return $this->container['appended'];
    }

    /**
     * Sets appended
     *
     * @param int $appended appended
     *
     * @return self
     */
    public function setAppended($appended)
    {
        if (is_null($appended)) {
            throw new \InvalidArgumentException('non-nullable appended cannot be null');
        }
        $this->container['appended'] = $appended;
     ...
     * Sets duplicates
     *
     * @param int $duplicates Events already held — a retry's share.
     *
     * @return self
     */
     ...
     * Gets rejected
     *
     * @return \ChatPanelSdk\Model\PushEventsResponseRejectedInner[]
     */
     ...
     * Sets rejected
     *
     * @param \ChatPanelSdk\Model\PushEventsResponseRejectedInner[] $rejected rejected
     *
     * @return self
     */
     ...
     * Sets cursor
     *
     * @param array<string,int> $cursor `{ host: seq }` — the highest seq held per host.
     *
     * @return self
     */
