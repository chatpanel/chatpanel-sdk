...
/**
 * DetectRequest Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class DetectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DetectRequest';
     ...
     * Sets model
     *
     * @param string|null $model A model this provider lists; 404 otherwise.
     *
     * @return self
     */
     ...
     * Sets labels
     *
     * @param string[]|null $labels Keep only these of the model's labels.
     *
     * @return self
     */
     ...
     * Sets budget_ms
     *
     * @param float|null $budget_ms Refused before running if the provider's record predicts it cannot be met.
     *
     * @return self
     */
    public function setBudgetMs($budget_ms)
    {
        ...
        if (($budget_ms < 0)) {
            throw new \InvalidArgumentException('invalid value for $budget_ms when calling DetectRequest., must be bigger than or equal to 0.');
        }
