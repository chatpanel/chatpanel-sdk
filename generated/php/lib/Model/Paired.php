 ...
 */
class Paired implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Paired';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bridge_token', $data ?? [], null);
    }
     ...
     * Sets token
     *
     * @param string $token The gateway token. A secret — store it 0600 or in the platform keychain; never log it.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getBridgeToken()
    {
        return $this->container['bridge_token'];
    }

    /**
     * Sets bridge_token
     *
     * @param string|null $bridge_token The bridge's token when this machine has one.
     *
     * @return self
     */
    public function setBridgeToken($bridge_token)
    {
        if (is_null($bridge_token)) {
            throw new \InvalidArgumentException('non-nullable bridge_token cannot be null');
        }
        $this->container['bridge_token'] = $bridge_token;
