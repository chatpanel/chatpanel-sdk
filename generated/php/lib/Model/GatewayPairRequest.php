...
/**
 * GatewayPairRequest Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class GatewayPairRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'gateway_pair_request';
     ...
     * Sets code
     *
     * @param string $code The 6-digit code from `chatpanel-gateway pair`.
     *
     * @return self
     */
