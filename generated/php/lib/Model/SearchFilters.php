...
class SearchFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 50)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SearchFilters., must be smaller than or equal to 50.');
        }
        if (($limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SearchFilters., must be bigger than or equal to 1.');
        }
