 ...
 */
class EventsPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EventsPage';
     ...
     * Sets cursor
     *
     * @param array<string,int> $cursor Pass back as `cursor` for the next page.
     *
     * @return self
     */
