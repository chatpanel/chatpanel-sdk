...
/**
 * RememberResponse Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class RememberResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RememberResponse';
    ...
    protected static $openAPITypes = [
        'ok' => 'bool',
        'action' => 'string',
        'record' => '\ChatPanelSdk\Model\Memory',
        'replaced' => '\ChatPanelSdk\Model\Memory',
        'size' => 'int'
    ];
     ...
     * Sets record
     *
     * @param \ChatPanelSdk\Model\Memory $record record
     *
     * @return self
     */
     ...
     * Sets replaced
     *
     * @param \ChatPanelSdk\Model\Memory|null $replaced replaced
     *
     * @return self
     */
    ...
    {
        if (is_null($replaced)) {
            array_push($this->openAPINullablesSetToNull, 'replaced');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('replaced', $nullablesSetToNull);
            if ($index !== FALSE) {
