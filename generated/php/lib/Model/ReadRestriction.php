...
/**
 * ReadRestriction Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class ReadRestriction implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReadRestriction';
    ...
    public const REASON_PAYWALL = 'paywall';
    public const REASON_RATE_LIMITED = 'rate_limited';
    public const REASON_ROBOTS = 'robots';
    public const REASON_TDM = 'tdm';
     ...
     * Sets reason
     *
     * @param string $reason `robots` and `tdm` come only from a hosted (crawler) provider; on the user's machine the reader is a user agent.
     *
     * @return self
     */
