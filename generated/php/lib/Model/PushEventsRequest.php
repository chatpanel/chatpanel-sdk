...
/**
 * PushEventsRequest Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class PushEventsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'events' => '\ChatPanelSdk\Model\CloudEvent[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['events']) > 2000)) {
            $invalidProperties[] = "invalid value for 'events', number of items must be less than or equal to 2000.";
        }
     ...
     * Gets events
     *
     * @return \ChatPanelSdk\Model\CloudEvent[]
     */
     ...
     * Sets events
     *
     * @param \ChatPanelSdk\Model\CloudEvent[] $events events
     *
     * @return self
     */
    public function setEvents($events)
    {
        ...
        if ((count($events) > 2000)) {
            throw new \InvalidArgumentException('invalid value for $events when calling PushEventsRequest., number of items must be less than or equal to 2000.');
        }
