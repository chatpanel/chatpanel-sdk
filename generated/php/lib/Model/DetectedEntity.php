...
/**
 * DetectedEntity Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class DetectedEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DetectedEntity';
     ...
     * Sets type
     *
     * @param string $type The model's own label.
     *
     * @return self
     */
     ...
     * Sets start
     *
     * @param int $start Character offset into the request text.
     *
     * @return self
     */
    ...
    public function setScore($score)
    {
        ...
        if (($score > 1)) {
            throw new \InvalidArgumentException('invalid value for $score when calling DetectedEntity., must be smaller than or equal to 1.');
        }
        if (($score < 0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling DetectedEntity., must be bigger than or equal to 0.');
        }
