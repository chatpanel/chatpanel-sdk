 ...
 */
class WhoAmI implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WhoAmI';
    ...
    public const TRUST_TOKEN = 'token';
    public const TRUST_PINNED = 'pinned';
    public const TRUST_UNPAIRED = 'unpaired';
    public const TRUST_LOCAL = 'local';
    public const TRUST_WEB = 'web';
     ...
     * @return string[]
     */
    public function getTrustAllowableValues()
    {
        return [
            self::TRUST_TOKEN,
            self::TRUST_PINNED,
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getTrustAllowableValues();
        if (!is_null($this->container['trust']) && !in_array($this->container['trust'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'trust', must be one of '%s'",
                $this->container['trust'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['paired'] === null) {
            $invalidProperties[] = "'paired' can't be null";
        }
    ...
    public function setTrust($trust)
    {
        ...
        $allowedValues = $this->getTrustAllowableValues();
        if (!in_array($trust, $allowedValues, true)) {
     ...
     * Sets paired
     *
     * @param bool $paired True when this caller may reach token-gated routes.
     *
     * @return self
     */
