...
/**
 * A2AResult Class Doc Comment
 *
 * @category Class
 * @description The reply, plus the two facts every caller derives — done, and what a person must do.
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class A2AResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'A2AResult';
    ...
    public const NEEDS_ANSWER = 'answer';
    public const NEEDS_APPROVAL = 'approval';
     ...
     * @return string[]
     */
    public function getNeedsAllowableValues()
    {
        return [
            self::NEEDS_ANSWER,
            self::NEEDS_APPROVAL,
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getNeedsAllowableValues();
        if (!is_null($this->container['needs']) && !in_array($this->container['needs'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'needs', must be one of '%s'",
     ...
     * Sets kind
     *
     * @param string|null $kind A2A returns one or the other; an agent answering at once creates no task.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param array<string,mixed>|null $message message
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text The answer as text — artifacts first, then what the agent actually said.
     *
     * @return self
     */
     ...
     * Sets needs
     *
     * @param string|null $needs `answer` for TASK_STATE_INPUT_REQUIRED, `approval` for TASK_STATE_AUTH_REQUIRED, null otherwise.
     *
     * @return self
     */
    ...
    {
        if (is_null($needs)) {
            throw new \InvalidArgumentException('non-nullable needs cannot be null');
        }
        $allowedValues = $this->getNeedsAllowableValues();
        if (!in_array($needs, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'needs', must be one of '%s'",
                    $needs,
