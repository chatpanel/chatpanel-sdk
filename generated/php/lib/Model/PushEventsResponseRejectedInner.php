...
/**
 * PushEventsResponseRejectedInner Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class PushEventsResponseRejectedInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PushEventsResponse_rejected_inner';
     ...
     * Sets code
     *
     * @param string $code `CLOUDEVENT` (envelope), `SEQ` (moved backwards), or event.js's `SHAPE` / `TYPE` / `PAYLOAD` / `VERSION`.
     *
     * @return self
     */
