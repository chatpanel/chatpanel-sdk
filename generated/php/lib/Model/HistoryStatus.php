 ...
 */
class HistoryStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HistoryStatus';
    ...
    protected static $openAPITypes = [
        ...
        'newest' => 'int',
        'bytes' => 'int',
        'lossless' => '\ChatPanelSdk\Model\HistoryStatusLossless'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('newest', $data ?? [], null);
    ...
    {
        if (is_null($newest)) {
            throw new \InvalidArgumentException('non-nullable newest cannot be null');
        }
     ...
     * Gets lossless
     *
     * @return \ChatPanelSdk\Model\HistoryStatusLossless|null
     */
     ...
     * Sets lossless
     *
     * @param \ChatPanelSdk\Model\HistoryStatusLossless|null $lossless lossless
     *
     * @return self
     */
    ...
    {
        if (is_null($lossless)) {
            array_push($this->openAPINullablesSetToNull, 'lossless');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lossless', $nullablesSetToNull);
            if ($index !== FALSE) {
