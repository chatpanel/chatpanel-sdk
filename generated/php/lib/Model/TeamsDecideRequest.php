...
/**
 * TeamsDecideRequest Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class TeamsDecideRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'teams_decide_request';
    ...
    public function setBy($by)
    {
        ...
        if ((mb_strlen($by) > 40)) {
            throw new \InvalidArgumentException('invalid length for $by when calling TeamsDecideRequest., must be smaller than or equal to 40.');
        }
