...
/**
 * MemorySyncRequest Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class MemorySyncRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'memory_sync_request';
    ...
    protected static $openAPITypes = [
        'upserts' => '\ChatPanelSdk\Model\Memory[]',
        'removes' => 'string[]'
    ];
    ...
    {
        $this->setIfExists('upserts', $data ?? [], null);
     ...
     * Gets upserts
     *
     * @return \ChatPanelSdk\Model\Memory[]|null
     */
    public function getUpserts()
    {
        return $this->container['upserts'];
    }

    /**
     * Sets upserts
     *
     * @param \ChatPanelSdk\Model\Memory[]|null $upserts upserts
     *
     * @return self
     */
    public function setUpserts($upserts)
    {
        if (is_null($upserts)) {
            throw new \InvalidArgumentException('non-nullable upserts cannot be null');
        }
        $this->container['upserts'] = $upserts;
     ...
     * Sets removes
     *
     * @param string[]|null $removes removes
     *
     * @return self
     */
