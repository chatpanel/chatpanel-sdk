...
/**
 * DecideQuestionOptionsInner Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class DecideQuestionOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DecideQuestion_options_inner';
     ...
     * Sets describe
     *
     * @param string|null $describe What the option means — travels to the model as its criterion.
     *
     * @return self
     */
