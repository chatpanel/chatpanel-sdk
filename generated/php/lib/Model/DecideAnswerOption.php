...
/**
 * DecideAnswerOption Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class DecideAnswerOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DecideAnswerOption';
     ...
     * Sets value
     *
     * @param mixed|null $value A string (choice, score rubric entry) or a boolean (noul).
     *
     * @return self
     */
    ...
    public function setP($p)
    {
        ...
        if (($p > 1)) {
            throw new \InvalidArgumentException('invalid value for $p when calling DecideAnswerOption., must be smaller than or equal to 1.');
        }
        if (($p < 0)) {
            throw new \InvalidArgumentException('invalid value for $p when calling DecideAnswerOption., must be bigger than or equal to 0.');
        }
