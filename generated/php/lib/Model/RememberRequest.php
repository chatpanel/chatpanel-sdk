...
/**
 * RememberRequest Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class RememberRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RememberRequest';
    ...
    protected static $openAPITypes = [
        ...
        'scope' => 'string',
        'tags' => 'string[]',
        'source' => '\ChatPanelSdk\Model\MemorySource'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('kind', $data ?? [], 'fact');
        $this->setIfExists('scope', $data ?? [], 'global');
     ...
     * Sets text
     *
     * @param string $text One short sentence.
     *
     * @return self
     */
     ...
     * Gets source
     *
     * @return \ChatPanelSdk\Model\MemorySource|null
     */
     ...
     * Sets source
     *
     * @param \ChatPanelSdk\Model\MemorySource|null $source source
     *
     * @return self
     */
