...
/**
 * AgentExportPlan Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class AgentExportPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AgentExportPlan';
     ...
     * Sets path
     *
     * @param string|null $path The exact file that would be written.
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text Its rendered contents.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status `theirs` means ChatPanel did not write it, or it has been edited since.
     *
     * @return self
     */
