...
/**
 * ChatCompletionChunkChoicesInner Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class ChatCompletionChunkChoicesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ChatCompletionChunk_choices_inner';
     ...
     * Sets delta
     *
     * @param array<string,mixed>|null $delta A domain object whose shape is owned by `@chatpanel/events`; the SDK carries it as-is.
     *
     * @return self
     */
