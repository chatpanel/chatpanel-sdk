...
/**
 * AgentCardCapabilities Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class AgentCardCapabilities implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AgentCard_capabilities';
    ...
    protected static $setters = [
        ...
        'extended_agent_card' => 'setExtendedAgentCard'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('extended_agent_card', $data ?? [], null);
    }
     ...
     * Sets streaming
     *
     * @param bool|null $streaming streaming
     *
     * @return self
     */
     ...
     *
     * @param bool|null $push_notifications push_notifications
     *
     * @return self
     */
    ...
    /**
     * Gets extended_agent_card
     *
     * @return bool|null
     */
    public function getExtendedAgentCard()
    {
        return $this->container['extended_agent_card'];
    }

    /**
     * Sets extended_agent_card
     *
     * @param bool|null $extended_agent_card extended_agent_card
     *
     * @return self
     */
    public function setExtendedAgentCard($extended_agent_card)
    {
        if (is_null($extended_agent_card)) {
            throw new \InvalidArgumentException('non-nullable extended_agent_card cannot be null');
        }
        $this->container['extended_agent_card'] = $extended_agent_card;
