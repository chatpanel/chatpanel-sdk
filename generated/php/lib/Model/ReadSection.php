 ...
 */
class ReadSection implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReadSection';
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['level'] > 6)) {
            $invalidProperties[] = "invalid value for 'level', must be smaller than or equal to 6.";
        }
     ...
     * Sets id
     *
     * @param string $id The page's own heading id when it has one, else a slug — cite as `url#id`.
     *
     * @return self
     */
    ...
    public function setLevel($level)
    {
        ...
        if (($level > 6)) {
            throw new \InvalidArgumentException('invalid value for $level when calling ReadSection., must be smaller than or equal to 6.');
        }
        if (($level < 1)) {
            throw new \InvalidArgumentException('invalid value for $level when calling ReadSection., must be bigger than or equal to 1.');
        }
     ...
     * Sets offset
     *
     * @param int $offset Character offset of the heading line into the content.
     *
     * @return self
     */
