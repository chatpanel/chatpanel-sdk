 ...
 */
class RecordsPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RecordsPage';
     ...
     * Sets records
     *
     * @param array[] $records Whole records; a tombstone carries `deletedAt`.
     *
     * @return self
     */
     ...
     * Sets next
     *
     * @param string|null $next The cursor for the next page — pass it as `cursor`; absent on the last page.
     *
     * @return self
     */
