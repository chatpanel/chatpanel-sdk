...
/**
 * AgentCardSupportedInterfacesInner Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class AgentCardSupportedInterfacesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AgentCard_supportedInterfaces_inner';
     ...
     *
     * @param string|null $protocol_binding JSONRPC, GRPC, HTTP+JSON — an open string, so an unknown binding is carried.
     *
     * @return self
     */
     ...
     * Sets tenant
     *
     * @param string|null $tenant Echoed on every request to this interface when set.
     *
     * @return self
     */
