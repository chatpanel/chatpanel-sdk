...
/**
 * DecideAnswer Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class DecideAnswer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DecideAnswer';
    ...
    protected static $openAPITypes = [
        'value' => 'mixed',
        'p' => 'float',
        'options' => '\ChatPanelSdk\Model\DecideAnswerOption[]',
        'confidence' => 'float'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['p'] > 1)) {
            $invalidProperties[] = "invalid value for 'p', must be smaller than or equal to 1.";
        }

        if (($this->container['p'] < 0)) {
     ...
     * Sets value
     *
     * @param mixed|null $value choice: the option picked; score: a number on the rubric; noul: a boolean.
     *
     * @return self
     */
     ...
     * Sets p
     *
     * @param float $p The probability of `value` — read it as one only when the response says `calibrated`.
     *
     * @return self
     */
    public function setP($p)
    {
        ...
        if (($p > 1)) {
            throw new \InvalidArgumentException('invalid value for $p when calling DecideAnswer., must be smaller than or equal to 1.');
        }
        if (($p < 0)) {
            throw new \InvalidArgumentException('invalid value for $p when calling DecideAnswer., must be bigger than or equal to 0.');
        }
     ...
     * Gets options
     *
     * @return \ChatPanelSdk\Model\DecideAnswerOption[]
     */
     ...
     * Sets options
     *
     * @param \ChatPanelSdk\Model\DecideAnswerOption[] $options The whole distribution.
     *
     * @return self
     */
     ...
     * Sets confidence
     *
     * @param float|null $confidence The provider's own confidence, when it reports one.
     *
     * @return self
     */
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling DecideAnswer., must be smaller than or equal to 1.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling DecideAnswer., must be bigger than or equal to 0.');
        }
