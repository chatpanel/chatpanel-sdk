...
/**
 * TeamsCheckpoint200Response Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class TeamsCheckpoint200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'teams_checkpoint_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('checkpoint', $data ?? [], null);
    }
     ...
     * Sets checkpoint
     *
     * @param array<string,mixed> $checkpoint A domain object whose shape is owned by `@chatpanel/events`; the SDK carries it as-is.
     *
     * @return self
     */
    public function setCheckpoint($checkpoint)
    {
        if (is_null($checkpoint)) {
            throw new \InvalidArgumentException('non-nullable checkpoint cannot be null');
        }
