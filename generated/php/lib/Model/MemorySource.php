...
/**
 * MemorySource Class Doc Comment
 *
 * @category Class
 * @description Who proposed the memory. There is no confirm dialog on a CLI, so attribution is the accountability.
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MemorySource implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MemorySource';
     ...
     * Sets via
     *
     * @param string|null $via The client — e.g. `sdk`, `cli`, `mcp`.
     *
     * @return self
     */
