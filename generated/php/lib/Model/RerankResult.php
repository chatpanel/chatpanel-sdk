...
/**
 * RerankResult Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class RerankResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RerankResult';
     ...
     * Sets index
     *
     * @param int $index Into the request's documents.
     *
     * @return self
     */
    public function setIndex($index)
    {
        ...
        if (($index < 0)) {
            throw new \InvalidArgumentException('invalid value for $index when calling RerankResult., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param float $relevance_score relevance_score
     *
     * @return self
     */
