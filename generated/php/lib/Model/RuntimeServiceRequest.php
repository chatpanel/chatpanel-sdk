...
/**
 * RuntimeServiceRequest Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class RuntimeServiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'runtime_service_request';
    ...
    public const ACTION_MODEL = 'model';
    ...
    {
        $this->setIfExists('action', $data ?? [], 'start');
     ...
     * Sets model
     *
     * @param string|null $model With `action: model` — a catalogue id or a Hugging Face owner/name.
     *
     * @return self
     */
