...
/**
 * AgentsListDefs200Response Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class AgentsListDefs200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'agents_listDefs_200_response';
    ...
    protected static $openAPITypes = [
        'agents' => '\ChatPanelSdk\Model\AgentDef[]',
        'quarantined' => 'array<string,mixed>[]',
        'problems' => 'array<string,mixed>[]'
    ];
     ...
     * Gets agents
     *
     * @return \ChatPanelSdk\Model\AgentDef[]
     */
     ...
     * Sets agents
     *
     * @param \ChatPanelSdk\Model\AgentDef[] $agents agents
     *
     * @return self
     */
     ...
     * Sets quarantined
     *
     * @param array<string,mixed>[]|null $quarantined Definitions the scanner refused.
     *
     * @return self
     */
     ...
     * Sets problems
     *
     * @param array<string,mixed>[]|null $problems Files that parsed as a definition and could not be made one.
     *
     * @return self
     */
