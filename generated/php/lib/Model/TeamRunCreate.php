...
/**
 * TeamRunCreate Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class TeamRunCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TeamRunCreate';
     ...
     * Sets client
     *
     * @param string|null $client Which client is running it.
     *
     * @return self
     */
     ...
     * Sets team
     *
     * @param array<string,mixed>|null $team A domain object whose shape is owned by `@chatpanel/events`; the SDK carries it as-is.
     *
     * @return self
     */
     ...
     * Sets request
     *
     * @param array<string,mixed>|null $request A domain object whose shape is owned by `@chatpanel/events`; the SDK carries it as-is.
     *
     * @return self
     */
