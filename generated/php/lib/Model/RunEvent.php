 ...
 */
class RunEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RunEvent';
     ...
     * Sets payload
     *
     * @param array<string,mixed>|null $payload A domain object whose shape is owned by `@chatpanel/events`; the SDK carries it as-is.
     *
     * @return self
     */
