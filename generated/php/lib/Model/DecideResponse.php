...
/**
 * DecideResponse Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class DecideResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DecideResponse';
    ...
    protected static $openAPITypes = [
        'answers' => 'array<string,\ChatPanelSdk\Model\DecideAnswer>',
        'model' => 'string',
        'ms' => 'float',
        'calibrated' => 'bool'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('calibrated', $data ?? [], null);
    }
     ...
     * Gets answers
     *
     * @return array<string,\ChatPanelSdk\Model\DecideAnswer>
     */
     ...
     * Sets answers
     *
     * @param array<string,\ChatPanelSdk\Model\DecideAnswer> $answers One per question asked, under the same key.
     *
     * @return self
     */
     ...
     * Sets calibrated
     *
     * @param bool|null $calibrated Whether `p` is a calibrated probability. false for a zero-shot NLI concentration.
     *
     * @return self
     */
    public function setCalibrated($calibrated)
    {
        if (is_null($calibrated)) {
            throw new \InvalidArgumentException('non-nullable calibrated cannot be null');
        }
