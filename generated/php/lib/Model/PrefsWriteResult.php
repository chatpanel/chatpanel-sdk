...
/**
 * PrefsWriteResult Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class PrefsWriteResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PrefsWriteResult';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('kept', $data ?? [], null);
    }
    ...
    {
        return $this->container['kept'];
    }

    /**
     * Sets kept
     *
     * @param string[]|null $kept kept
     *
     * @return self
     */
    ...
    {
        if (is_null($kept)) {
            throw new \InvalidArgumentException('non-nullable kept cannot be null');
        }
        $this->container['kept'] = $kept;
