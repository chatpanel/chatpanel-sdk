...
/**
 * A2aCard200Response Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class A2aCard200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'a2a_card_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fresh', $data ?? [], null);
     ...
     * Sets fingerprint
     *
     * @param string|null $fingerprint Changes when the card's content does.
     *
     * @return self
     */
    ...
    {
        return $this->container['fresh'];
    }

    /**
     * Sets fresh
     *
     * @param bool|null $fresh false when the peer answered 304.
     *
     * @return self
     */
    ...
    {
        if (is_null($fresh)) {
            throw new \InvalidArgumentException('non-nullable fresh cannot be null');
        }
        $this->container['fresh'] = $fresh;
