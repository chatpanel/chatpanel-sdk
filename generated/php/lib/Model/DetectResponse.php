...
/**
 * DetectResponse Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class DetectResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DetectResponse';
    ...
    protected static $openAPITypes = [
        'entities' => '\ChatPanelSdk\Model\DetectedEntity[]',
        'model' => 'string',
        'ms' => 'float',
     ...
     * Gets entities
     *
     * @return \ChatPanelSdk\Model\DetectedEntity[]
     */
     ...
     * Sets entities
     *
     * @param \ChatPanelSdk\Model\DetectedEntity[] $entities entities
     *
     * @return self
     */
     ...
     * Sets runtime
     *
     * @param array<string,mixed>|null $runtime A domain object whose shape is owned by `@chatpanel/events`; the SDK carries it as-is.
     *
     * @return self
     */
