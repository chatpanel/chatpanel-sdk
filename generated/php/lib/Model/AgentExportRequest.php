...
/**
 * AgentExportRequest Class Doc Comment
 *
 * @category Class
 * @package  ChatPanelSdk
 * @author   OpenAPI Generator team
 ...
 */
class AgentExportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AgentExportRequest';
    ...
    public const TO_CLAUDE = 'claude';
    public const TO_CODEX = 'codex';
    public const TO_CHATPANEL = 'chatpanel';
     ...
     * Sets agent
     *
     * @param \ChatPanelSdk\Model\AgentDef $agent agent
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param string $to The dialect to write.
     *
     * @return self
     */
     ...
     * Sets overwrite
     *
     * @param bool|null $overwrite Only ever after a plan reported `theirs` and a person agreed.
     *
     * @return self
     */
