...
*AudioApi* | [**audioSpeech**](docs/Api/AudioApi.md#audiospeech) | **POST** /v1/audio/speech | Text to speech (OpenAI-compatible) — a WAV back.
*AudioApi* | [**audioTranscribe**](docs/Api/AudioApi.md#audiotranscribe) | **POST** /v1/audio/transcriptions | Transcribe an audio file (OpenAI-compatible).
...
*EventsApi* | [**eventsStats**](docs/Api/EventsApi.md#eventsstats) | **GET** /v1/events/stats | What the merged log measures — bytes and events per turn, per surface, per host and per day; the dedup hit-rate; tool calls; a year projected against the cap.
...
*FusionsApi* | [**fusionsList**](docs/Api/FusionsApi.md#fusionslist) | **GET** /v1/fusions | Several models as one — the fusions this gateway has.
...
*TeamsApi* | [**teamsStream**](docs/Api/TeamsApi.md#teamsstream) | **GET** /v1/teams/stream | Run changes, pushed — &#x60;hello&#x60; once, then a &#x60;run&#x60; notice whenever a run is created, moves or is removed.
...
- [EventsStats](docs/Model/EventsStats.md)
- [EventsStatsStats](docs/Model/EventsStatsStats.md)
...
- [FusionList](docs/Model/FusionList.md)
- [FusionListFusionsInner](docs/Model/FusionListFusionsInner.md)
- [FusionListFusionsInnerMembersInner](docs/Model/FusionListFusionsInnerMembersInner.md)
- [FusionListFusionsInnerMembersInnerOneOf](docs/Model/FusionListFusionsInnerMembersInnerOneOf.md)
- [FusionListKindsValue](docs/Model/FusionListKindsValue.md)
...
- [TeamsStreamEvent](docs/Model/TeamsStreamEvent.md)
- [Transcription](docs/Model/Transcription.md)
- [TranscriptionSegmentsInner](docs/Model/TranscriptionSegmentsInner.md)
