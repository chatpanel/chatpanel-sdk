...
import net.chatpanel.sdk.model.HistoryItem;
 ...
 */
@JsonPropertyOrder({
  HistoryPage.JSON_PROPERTY_OK,
  HistoryPage.JSON_PROPERTY_TOTAL,
  HistoryPage.JSON_PROPERTY_ITEMS
})
...
public class HistoryPage {
  ...
  public HistoryPage ok(@jakarta.annotation.Nonnull Boolean ok) {
    this.ok = ok;
    return this;
  }
  ...
  public HistoryPage total(@jakarta.annotation.Nonnull Integer total) {
    this.total = total;
    return this;
  }
  ...
  public HistoryPage items(@jakarta.annotation.Nonnull List<HistoryItem> items) {
    this.items = items;
    return this;
  }

  public HistoryPage addItemsItem(HistoryItem itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ITEMS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@jakarta.annotation.Nonnull List<HistoryItem> items) {
    this.items = items;
  }


  /**
   * Return true if this HistoryPage object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    HistoryPage historyPage = (HistoryPage) o;
    return Objects.equals(this.ok, historyPage.ok) &&
        Objects.equals(this.total, historyPage.total) &&
        Objects.equals(this.items, historyPage.items);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ok, total, items);
  }
