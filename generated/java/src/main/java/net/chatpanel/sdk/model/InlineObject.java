 ...
 */
@JsonPropertyOrder({
  InlineObject.JSON_PROPERTY_OK,
  InlineObject.JSON_PROPERTY_RUN
})
...
public class InlineObject {
  ...
  public InlineObject ok(@jakarta.annotation.Nonnull Boolean ok) {
    this.ok = ok;
    return this;
  }
  ...
  public InlineObject run(@jakarta.annotation.Nonnull TeamRun run) {
    this.run = run;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_RUN, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public TeamRun getRun() {
    return run;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_RUN, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRun(@jakarta.annotation.Nonnull TeamRun run) {
    this.run = run;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ok, inlineObject.ok) &&
        Objects.equals(this.run, inlineObject.run);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ok, run);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getRun() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%srun%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRun()))));
    }
