 ...
 */
@JsonPropertyOrder({
  RetrievalReadAlias200Response.JSON_PROPERTY_CODE,
  RetrievalReadAlias200Response.JSON_PROPERTY_STATUS,
  RetrievalReadAlias200Response.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class RetrievalReadAlias200Response {
  ...
  public RetrievalReadAlias200Response() { 
  }

  public RetrievalReadAlias200Response code(@jakarta.annotation.Nonnull Integer code) {
    this.code = code;
    return this;
  }
  ...
  public RetrievalReadAlias200Response status(@jakarta.annotation.Nonnull Integer status) {
    this.status = status;
    return this;
  }
  ...
  public RetrievalReadAlias200Response data(@jakarta.annotation.Nonnull ReadResponse data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull ReadResponse data) {
    this.data = data;
  }


  /**
   * Return true if this retrieval_readAlias_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RetrievalReadAlias200Response retrievalReadAlias200Response = (RetrievalReadAlias200Response) o;
    return Objects.equals(this.code, retrievalReadAlias200Response.code) &&
        Objects.equals(this.status, retrievalReadAlias200Response.status) &&
        Objects.equals(this.data, retrievalReadAlias200Response.data);
  }
