 ...
 */
@JsonPropertyOrder({
  PushEventsRequest.JSON_PROPERTY_EVENTS
})
...
public class PushEventsRequest {
  ...
  public PushEventsRequest() { 
  }

  public PushEventsRequest events(@jakarta.annotation.Nonnull List<CloudEvent> events) {
    this.events = events;
    return this;
  }

  public PushEventsRequest addEventsItem(CloudEvent eventsItem) {
    if (this.events == null) {
  ...
  /**
   * Return true if this PushEventsRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.events, pushEventsRequest.events);
  }
