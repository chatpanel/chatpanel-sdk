 ...
 */
@JsonPropertyOrder({
  ChatCompletion.JSON_PROPERTY_ID,
  ChatCompletion.JSON_PROPERTY_OBJECT,
  ChatCompletion.JSON_PROPERTY_CREATED,
  ChatCompletion.JSON_PROPERTY_MODEL,
  ChatCompletion.JSON_PROPERTY_CHOICES,
  ChatCompletion.JSON_PROPERTY_USAGE
})
...
public class ChatCompletion {
  ...
  @jakarta.annotation.Nonnull
  private List<ChatCompletionChoicesInner> choices = new ArrayList<>();
  ...
  public ChatCompletion id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ChatCompletion _object(@jakarta.annotation.Nonnull String _object) {
  ...
  public ChatCompletion created(@jakarta.annotation.Nullable Integer created) {
  ...
  public ChatCompletion model(@jakarta.annotation.Nullable String model) {
    this.model = model;
    return this;
  }
  ...
  public ChatCompletion choices(@jakarta.annotation.Nonnull List<ChatCompletionChoicesInner> choices) {
    this.choices = choices;
    return this;
  }

  public ChatCompletion addChoicesItem(ChatCompletionChoicesInner choicesItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public List<ChatCompletionChoicesInner> getChoices() {
    return choices;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CHOICES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setChoices(@jakarta.annotation.Nonnull List<ChatCompletionChoicesInner> choices) {
    this.choices = choices;
  }


  public ChatCompletion usage(@jakarta.annotation.Nullable Map<String, Object> usage) {
    this.usage = usage;
    return this;
  }

  public ChatCompletion putUsageItem(String key, Object usageItem) {
    if (this.usage == null) {
   ...
   */
  @JsonAnySetter
  public ChatCompletion putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this ChatCompletion object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ChatCompletion chatCompletion = (ChatCompletion) o;
    return Objects.equals(this.id, chatCompletion.id) &&
        Objects.equals(this._object, chatCompletion._object) &&
        Objects.equals(this.created, chatCompletion.created) &&
        Objects.equals(this.model, chatCompletion.model) &&
        Objects.equals(this.choices, chatCompletion.choices) &&
        Objects.equals(this.usage, chatCompletion.usage)&&
        Objects.equals(this.additionalProperties, chatCompletion.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, _object, created, model, choices, usage, additionalProperties);
  }
