 ...
 */
@JsonPropertyOrder({
  TranscriptionSegmentsInner.JSON_PROPERTY_ID,
  TranscriptionSegmentsInner.JSON_PROPERTY_START,
  TranscriptionSegmentsInner.JSON_PROPERTY_END,
  TranscriptionSegmentsInner.JSON_PROPERTY_TEXT,
  TranscriptionSegmentsInner.JSON_PROPERTY_SPEAKER
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class TranscriptionSegmentsInner {
  ...
  public TranscriptionSegmentsInner() { 
  }

  public TranscriptionSegmentsInner id(@jakarta.annotation.Nonnull Integer id) {
    this.id = id;
    return this;
  }
  ...
  public TranscriptionSegmentsInner start(@jakarta.annotation.Nonnull BigDecimal start) {
    this.start = start;
    return this;
  }
  ...
  public TranscriptionSegmentsInner end(@jakarta.annotation.Nonnull BigDecimal end) {
    this.end = end;
    return this;
  }
  ...
  public TranscriptionSegmentsInner text(@jakarta.annotation.Nonnull String text) {
    this.text = text;
    return this;
  }
  ...
  public TranscriptionSegmentsInner speaker(@jakarta.annotation.Nullable String speaker) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SPEAKER, required = false)
  ...
  /**
   * Return true if this Transcription_segments_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TranscriptionSegmentsInner transcriptionSegmentsInner = (TranscriptionSegmentsInner) o;
    return Objects.equals(this.id, transcriptionSegmentsInner.id) &&
        Objects.equals(this.start, transcriptionSegmentsInner.start) &&
        Objects.equals(this.end, transcriptionSegmentsInner.end) &&
        Objects.equals(this.text, transcriptionSegmentsInner.text) &&
        Objects.equals(this.speaker, transcriptionSegmentsInner.speaker);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, start, end, text, speaker);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `speaker` to the URL query string
    if (getSpeaker() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sspeaker%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSpeaker()))));
    }
