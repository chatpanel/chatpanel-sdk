 ...
 */
@JsonPropertyOrder({
  MemoryList.JSON_PROPERTY_OK,
  MemoryList.JSON_PROPERTY_SIZE,
  MemoryList.JSON_PROPERTY_MEMORIES
})
...
public class MemoryList {
  ...
  public MemoryList ok(@jakarta.annotation.Nonnull Boolean ok) {
    this.ok = ok;
    return this;
  }
  ...
  public MemoryList size(@jakarta.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public MemoryList memories(@jakarta.annotation.Nonnull List<Memory> memories) {
    this.memories = memories;
    return this;
  }

  public MemoryList addMemoriesItem(Memory memoriesItem) {
  ...
  /**
   * Return true if this MemoryList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ok, memoryList.ok) &&
        Objects.equals(this.size, memoryList.size) &&
        Objects.equals(this.memories, memoryList.memories);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ok, size, memories);
  }
