 ...
 */
@JsonPropertyOrder({
  IngestRequestUpsertsInner.JSON_PROPERTY_ID,
  IngestRequestUpsertsInner.JSON_PROPERTY_TITLE,
  IngestRequestUpsertsInner.JSON_PROPERTY_TYPE,
  IngestRequestUpsertsInner.JSON_PROPERTY_DATE,
  IngestRequestUpsertsInner.JSON_PROPERTY_TEXT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class IngestRequestUpsertsInner {
  ...
  public IngestRequestUpsertsInner() { 
  }

  public IngestRequestUpsertsInner id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public IngestRequestUpsertsInner title(@jakarta.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public IngestRequestUpsertsInner type(@jakarta.annotation.Nullable RecordType type) {
    this.type = type;
    return this;
  }
  ...
  public IngestRequestUpsertsInner date(@jakarta.annotation.Nullable Long date) {
    this.date = date;
    return this;
  }
  ...
  public IngestRequestUpsertsInner text(@jakarta.annotation.Nonnull String text) {
    this.text = text;
    return this;
  }
   ...
   */
  @JsonAnySetter
  public IngestRequestUpsertsInner putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this IngestRequest_upserts_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IngestRequestUpsertsInner ingestRequestUpsertsInner = (IngestRequestUpsertsInner) o;
    return Objects.equals(this.id, ingestRequestUpsertsInner.id) &&
        Objects.equals(this.title, ingestRequestUpsertsInner.title) &&
        Objects.equals(this.type, ingestRequestUpsertsInner.type) &&
        Objects.equals(this.date, ingestRequestUpsertsInner.date) &&
        Objects.equals(this.text, ingestRequestUpsertsInner.text)&&
        Objects.equals(this.additionalProperties, ingestRequestUpsertsInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, title, type, date, text, additionalProperties);
  }
