...
public class FusionsApi {
  ...
  public FusionsApi(ApiClient apiClient) {
   ...
   */
  public FusionList fusionsList() throws ApiException {
    return fusionsList(null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public FusionList fusionsList(Map<String, String> headers) throws ApiException {
    ApiResponse<FusionList> localVarResponse = fusionsListWithHttpInfo(headers);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<FusionList> fusionsListWithHttpInfo() throws ApiException {
    return fusionsListWithHttpInfo(null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<FusionList> fusionsListWithHttpInfo(Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = fusionsListRequestBuilder(headers);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("fusionsList", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<FusionList>(
        ...
        FusionList responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<FusionList>() {});
  ...
  private HttpRequest.Builder fusionsListRequestBuilder(Map<String, String> headers) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v1/fusions";
