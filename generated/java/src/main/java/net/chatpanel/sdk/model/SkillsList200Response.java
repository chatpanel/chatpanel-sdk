 ...
 */
@JsonPropertyOrder({
  SkillsList200Response.JSON_PROPERTY_SKILLS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class SkillsList200Response {
  public static final String JSON_PROPERTY_SKILLS = "skills";
  @jakarta.annotation.Nonnull
  private List<Skill> skills = new ArrayList<>();

  public SkillsList200Response() { 
  }

  public SkillsList200Response skills(@jakarta.annotation.Nonnull List<Skill> skills) {
    this.skills = skills;
    return this;
  }

  public SkillsList200Response addSkillsItem(Skill skillsItem) {
    if (this.skills == null) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_SKILLS, required = true)
  ...
  @JsonProperty(value = JSON_PROPERTY_SKILLS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSkills(@jakarta.annotation.Nonnull List<Skill> skills) {
    this.skills = skills;
  }


  /**
   * Return true if this skills_list_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SkillsList200Response skillsList200Response = (SkillsList200Response) o;
    return Objects.equals(this.skills, skillsList200Response.skills);
  }
