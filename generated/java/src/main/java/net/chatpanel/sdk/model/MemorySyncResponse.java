 ...
 */
@JsonPropertyOrder({
  MemorySyncResponse.JSON_PROPERTY_OK,
  MemorySyncResponse.JSON_PROPERTY_SIZE,
  MemorySyncResponse.JSON_PROPERTY_MEMORIES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class MemorySyncResponse {
  ...
  public MemorySyncResponse ok(@jakarta.annotation.Nonnull Boolean ok) {
    this.ok = ok;
    return this;
  }
  ...
  public MemorySyncResponse size(@jakarta.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public MemorySyncResponse memories(@jakarta.annotation.Nonnull List<Memory> memories) {
    this.memories = memories;
    return this;
  }

  public MemorySyncResponse addMemoriesItem(Memory memoriesItem) {
   ...
   */
  @JsonAnySetter
  public MemorySyncResponse putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this MemorySyncResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MemorySyncResponse memorySyncResponse = (MemorySyncResponse) o;
    return Objects.equals(this.ok, memorySyncResponse.ok) &&
        Objects.equals(this.size, memorySyncResponse.size) &&
        Objects.equals(this.memories, memorySyncResponse.memories)&&
        Objects.equals(this.additionalProperties, memorySyncResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ok, size, memories, additionalProperties);
  }
