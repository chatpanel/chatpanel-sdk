 ...
 */
@JsonPropertyOrder({
  AgentFidelityDroppedInner.JSON_PROPERTY_FIELD,
  AgentFidelityDroppedInner.JSON_PROPERTY_WHY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class AgentFidelityDroppedInner {
  ...
  public AgentFidelityDroppedInner() { 
  }

  public AgentFidelityDroppedInner field(@jakarta.annotation.Nullable String field) {
    this.field = field;
    return this;
  }
  ...
  public AgentFidelityDroppedInner why(@jakarta.annotation.Nullable String why) {
    this.why = why;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_WHY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_WHY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWhy(@jakarta.annotation.Nullable String why) {
    this.why = why;
  }


  /**
   * Return true if this AgentFidelity_dropped_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AgentFidelityDroppedInner agentFidelityDroppedInner = (AgentFidelityDroppedInner) o;
    return Objects.equals(this.field, agentFidelityDroppedInner.field) &&
        Objects.equals(this.why, agentFidelityDroppedInner.why);
  }

  @Override
  public int hashCode() {
    return Objects.hash(field, why);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `why` to the URL query string
    if (getWhy() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%swhy%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getWhy()))));
    }
