 ...
 */
@JsonPropertyOrder({
  Paired.JSON_PROPERTY_OK,
  Paired.JSON_PROPERTY_TOKEN,
  Paired.JSON_PROPERTY_BRIDGE_TOKEN
})
...
public class Paired {
  ...
  public static final String JSON_PROPERTY_BRIDGE_TOKEN = "bridgeToken";
  ...
  public Paired ok(@jakarta.annotation.Nonnull Boolean ok) {
    this.ok = ok;
    return this;
  }
  ...
  public Paired token(@jakarta.annotation.Nonnull String token) {
    this.token = token;
    return this;
  }
  ...
  public Paired bridgeToken(@jakarta.annotation.Nullable String bridgeToken) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_BRIDGE_TOKEN, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_BRIDGE_TOKEN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBridgeToken(@jakarta.annotation.Nullable String bridgeToken) {
    this.bridgeToken = bridgeToken;
  }


  /**
   * Return true if this Paired object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ok, paired.ok) &&
        Objects.equals(this.token, paired.token) &&
        Objects.equals(this.bridgeToken, paired.bridgeToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ok, token, bridgeToken);
  }
  ...
  public String toString() {
    ...
    sb.append("    bridgeToken: ").append(toIndentedString(bridgeToken)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `bridgeToken` to the URL query string
    if (getBridgeToken() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sbridgeToken%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBridgeToken()))));
    }
