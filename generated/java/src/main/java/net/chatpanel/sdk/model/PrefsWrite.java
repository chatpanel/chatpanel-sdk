 ...
 */
@JsonPropertyOrder({
  PrefsWrite.JSON_PROPERTY_SECTIONS,
  PrefsWrite.JSON_PROPERTY_BY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class PrefsWrite {
  ...
  public PrefsWrite sections(@jakarta.annotation.Nonnull Map<String, PrefSection> sections) {
    this.sections = sections;
    return this;
  }

  public PrefsWrite putSectionsItem(String key, PrefSection sectionsItem) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SECTIONS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSections(@jakarta.annotation.Nonnull Map<String, PrefSection> sections) {
    this.sections = sections;
  }


  public PrefsWrite by(@jakarta.annotation.Nullable String by) {
    this.by = by;
    return this;
  }
  ...
  /**
   * Return true if this PrefsWrite object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PrefsWrite prefsWrite = (PrefsWrite) o;
    return Objects.equals(this.sections, prefsWrite.sections) &&
        Objects.equals(this.by, prefsWrite.by);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sections, by);
  }
