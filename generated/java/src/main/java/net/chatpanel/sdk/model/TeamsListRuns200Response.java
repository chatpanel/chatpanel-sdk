 ...
 */
@JsonPropertyOrder({
  TeamsListRuns200Response.JSON_PROPERTY_OK,
  TeamsListRuns200Response.JSON_PROPERTY_RUNS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class TeamsListRuns200Response {
  ...
  @jakarta.annotation.Nonnull
  private List<TeamRun> runs = new ArrayList<>();

  public TeamsListRuns200Response() { 
  }

  public TeamsListRuns200Response ok(@jakarta.annotation.Nonnull Boolean ok) {
    this.ok = ok;
    return this;
  }
  ...
  public TeamsListRuns200Response runs(@jakarta.annotation.Nonnull List<TeamRun> runs) {
    this.runs = runs;
    return this;
  }

  public TeamsListRuns200Response addRunsItem(TeamRun runsItem) {
    if (this.runs == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RUNS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRuns(@jakarta.annotation.Nonnull List<TeamRun> runs) {
    this.runs = runs;
  }


  /**
   * Return true if this teams_listRuns_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TeamsListRuns200Response teamsListRuns200Response = (TeamsListRuns200Response) o;
    return Objects.equals(this.ok, teamsListRuns200Response.ok) &&
        Objects.equals(this.runs, teamsListRuns200Response.runs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ok, runs);
  }
