...
public class ModelsApi {
   ...
   */
  public ModelList modelsList() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ModelList modelsList(Map<String, String> headers) throws ApiException {
    ApiResponse<ModelList> localVarResponse = modelsListWithHttpInfo(headers);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ModelList> modelsListWithHttpInfo() throws ApiException {
    return modelsListWithHttpInfo(null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ModelList> modelsListWithHttpInfo(Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = modelsListRequestBuilder(headers);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("modelsList", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<ModelList>(
        ...
        ModelList responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<ModelList>() {});
  ...
  private HttpRequest.Builder modelsListRequestBuilder(Map<String, String> headers) throws ApiException {
