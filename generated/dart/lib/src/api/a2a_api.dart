...
class A2aApi {
  ...
  const A2aApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [A2aAgents200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<A2aAgents200Response>> a2aAgents({ 
    ...
    A2aAgents200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(A2aAgents200Response),
      ) as A2aAgents200Response;
    ...
    return Response<A2aAgents200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [A2aCard200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<A2aCard200Response>> a2aCard({ 
    required A2aCardRequest a2aCardRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(A2aCardRequest);
      _bodyData = _serializers.serialize(a2aCardRequest, specifiedType: _type);
    ...
    A2aCard200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(A2aCard200Response),
      ) as A2aCard200Response;
    ...
    return Response<A2aCard200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [A2AResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<A2AResult>> a2aMessage({ 
    required A2ASendRequest a2ASendRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(A2ASendRequest);
      _bodyData = _serializers.serialize(a2ASendRequest, specifiedType: _type);
    ...
    A2AResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(A2AResult),
      ) as A2AResult;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> a2aStream({ 
    required A2ASendRequest a2ASendRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/a2a/message/stream';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [A2AResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<A2AResult>> a2aTask({ 
    required A2aTaskRequest a2aTaskRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(A2aTaskRequest);
      _bodyData = _serializers.serialize(a2aTaskRequest, specifiedType: _type);
