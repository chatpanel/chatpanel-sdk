...
class EventsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [EventsCursor] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventsCursor>> eventsCursor({ 
    ...
    final _path = r'/v1/events/cursor';
    ...
    EventsCursor? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EventsCursor),
      ) as EventsCursor;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PushEventsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PushEventsResponse>> eventsPush({ 
    required PushEventsRequest pushEventsRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PushEventsRequest);
      _bodyData = _serializers.serialize(pushEventsRequest, specifiedType: _type);
    ...
    PushEventsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PushEventsResponse),
      ) as PushEventsResponse;
    ...
    return Response<PushEventsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [cursor] - JSON `{ host: seq }` — the highest seq per host you already hold. Absent means everything.
  /// * [limit] 
  /// * [host] - One host's slice only.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EventsPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventsPage>> eventsSince({ 
    String? cursor,
    int? limit = 1000,
    String? host,
    CancelToken? cancelToken,
    ...
    EventsPage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EventsPage),
      ) as EventsPage;
  ...
  ///
  /// Parameters:
  /// * [cursor] - JSON `{ host: seq }`; when present the events above it are replayed before live frames.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> eventsStream({ 
    String? cursor,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/events/stream';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
