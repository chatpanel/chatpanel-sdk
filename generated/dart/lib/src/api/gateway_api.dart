...
class GatewayApi {
  ...
  const GatewayApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Audit] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Audit>> gatewayAudit({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Health>> gatewayHealth({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Paired] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Paired>> gatewayPair({ 
    required GatewayPairRequest gatewayPairRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(GatewayPairRequest);
      _bodyData = _serializers.serialize(gatewayPairRequest, specifiedType: _type);
    ...
    Paired? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(Paired),
      ) as Paired;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PairingCode>> gatewayPairCode({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [WhoAmI] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WhoAmI>> gatewayWhoami({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    WhoAmI? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(WhoAmI),
      ) as WhoAmI;
