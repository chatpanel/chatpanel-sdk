...
/// * [text] 
@BuiltValue()
abstract class HistoryRecord implements Built<HistoryRecord, HistoryRecordBuilder> {
  ...
  factory HistoryRecord([void updates(HistoryRecordBuilder b)]) = _$HistoryRecord;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HistoryRecordBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HistoryRecord> get serializer => _$HistoryRecordSerializer();
}

class _$HistoryRecordSerializer implements PrimitiveSerializer<HistoryRecord> {
  @override
  final Iterable<Type> types = const [HistoryRecord, _$HistoryRecord];

  @override
  final String wireName = r'HistoryRecord';
  ...
  void _deserializeProperties(
    ...
    required HistoryRecordBuilder result,
