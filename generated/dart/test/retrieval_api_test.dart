...
/// tests for RetrievalApi
void main() {
  final instance = Chatpanel().getRetrievalApi();
  ...
  group(RetrievalApi, () {
    ...
    //
    //Future<ExtractResponse> retrievalExtract(ExtractRequest extractRequest) async
    test('test retrievalExtract', () async {
      // TODO
    });
    ...
    //
    //Future<ReadResponse> retrievalRead(ReadRequest readRequest) async
    test('test retrievalRead', () async {
      // TODO
    });
    ...
    //
    //Future<String> retrievalReadAlias(String url, { String accept, String xReturnFormat }) async
    test('test retrievalReadAlias', () async {
      // TODO
    });
    ...
    //
    //Future<WebSearchResponse> retrievalSearch(WebSearchRequest webSearchRequest) async
    test('test retrievalSearch', () async {
      // TODO
    });
    ...
    //
    //Future<RetrievalSearchAlias200Response> retrievalSearchAlias(String q, { int read }) async
    test('test retrievalSearchAlias', () async {
      // TODO
    });
